...
class HXCPP_CLASS_ATTRIBUTES BlobList_obj : public hx::Object
{
	...
	public:
		...
		::Dynamic get_dyn();
		 ...
		 ::kha::internal::BytesBlob OpenSans_sfd;
		::String OpenSans_sfdName;
		 ::Dynamic OpenSans_sfdDescription;
		void OpenSans_sfdLoad( ::Dynamic done, ::Dynamic failure);
		::Dynamic OpenSans_sfdLoad_dyn();

		void OpenSans_sfdUnload();
		::Dynamic OpenSans_sfdUnload_dyn();

		 ::kha::internal::BytesBlob l0_xml;
		::String l0_xmlName;
		 ::Dynamic l0_xmlDescription;
		void l0_xmlLoad( ::Dynamic done, ::Dynamic failure);
		::Dynamic l0_xmlLoad_dyn();

		void l0_xmlUnload();
		::Dynamic l0_xmlUnload_dyn();
