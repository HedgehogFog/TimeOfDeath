...
HXLINE( 662)		{
HXLINE( 663)			 ::zpp_nape::geom::ZPP_GeomVert F = P;
HXLINE( 664)			 ::zpp_nape::geom::ZPP_GeomVert L = P;
HXLINE( 665)			if (hx::IsNotNull( F )) {
HXLINE( 666)				 ::zpp_nape::geom::ZPP_GeomVert nite = F;
...
HXLINE( 667)					if (!(hx::IsNotEq( nite,L ))) {
...
HXLINE( 904)						 ::zpp_nape::geom::ZPP_PartitionVertex c = nite;
HXLINE( 906)						c->sort();
...
HXLINE( 976)					 ::zpp_nape::geom::ZPP_PartitionedPoly p = cx_ite->elt;
HXLINE( 977)					{
HXLINE( 978)						if (p->remove_collinear_vertices()) {
...
HXDLIN(1024)				 ::zpp_nape::geom::ZPP_PartitionVertex diag = ret2;
HXLINE(1025)				if (hx::IsEq( diag,start )) {
...
HXLINE(1147)						 ::zpp_nape::geom::ZPP_PartitionVertex c = nite;
HXLINE(1149)						c->sort();
...
HXLINE(1223)			Float x = next->x;
HXDLIN(1223)			Float y = next->y;
HXDLIN(1223)			 ::zpp_nape::geom::ZPP_GeomVert ret1;
HXDLIN(1223)			{
...
HXDLIN(1223)			{
HXLINE(1223)				ret1->x = x;
HXDLIN(1223)				ret1->y = y;
            			}
...
HXLINE(1233)			poly->forced = next->forced;
...
HXDLIN(1235)				 ::zpp_nape::geom::ZPP_PartitionVertex diag = ret2;
HXLINE(1236)				if (hx::IsEq( diag,start )) {
