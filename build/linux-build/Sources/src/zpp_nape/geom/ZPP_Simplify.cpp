...
HXLINE( 342)		Float den = ((nx * nx) + (ny * ny));
HXLINE( 343)		if ((den == ((Float)0.0))) {
...
HXLINE( 349)					{
HXLINE( 350)						Float t1 = t;
HXLINE( 359)						cx = (cx - (nx * t1));
HXLINE( 360)						cy = (cy - (ny * t1));
            					}
...
HXLINE( 383)					 ::zpp_nape::util::ZNPList_ZPP_SimplifyP _hx_tmp = ::zpp_nape::geom::ZPP_Simplify_obj::stack;
HXDLIN( 383)					 ::zpp_nape::geom::ZPP_SimplifyP ret2;
...
HXLINE( 388)			 ::zpp_nape::geom::ZPP_SimplifyV obj = v;
HXLINE( 389)			if (hx::IsNull( ret )) {
HXLINE( 389)				ret = (obj->prev = (obj->next = obj));
            			}
            			else {
HXLINE( 391)				obj->prev = ret;
HXLINE( 392)				obj->next = ret->next;
HXLINE( 393)				ret->next->prev = obj;
HXLINE( 394)				ret->next = obj;
            			}
HXLINE( 396)			ret = obj;
...
HXLINE( 403)				if ((((ret->x - min->x) + (ret->y - min->y)) < ((Float)0.0))) {
HXLINE( 403)					min = ret;
            				}
HXLINE( 404)				if ((((max->x - ret->x) + (max->y - ret->y)) < ((Float)0.0))) {
HXLINE( 404)					max = ret;
            				}
            			}
...
HXLINE( 412)				 ::zpp_nape::util::ZNPList_ZPP_SimplifyP _hx_tmp1 = ::zpp_nape::geom::ZPP_Simplify_obj::stack;
HXDLIN( 412)				 ::zpp_nape::geom::ZPP_SimplifyP ret3;
...
HXDLIN( 412)				_hx_tmp1->add(ret3);
HXLINE( 413)				 ::zpp_nape::util::ZNPList_ZPP_SimplifyP _hx_tmp2 = ::zpp_nape::geom::ZPP_Simplify_obj::stack;
HXDLIN( 413)				 ::zpp_nape::geom::ZPP_SimplifyP ret4;
...
HXLINE( 422)					 ::zpp_nape::util::ZNPList_ZPP_SimplifyP _hx_tmp3 = ::zpp_nape::geom::ZPP_Simplify_obj::stack;
HXDLIN( 422)					 ::zpp_nape::geom::ZPP_SimplifyP ret5;
...
HXDLIN( 422)					_hx_tmp3->add(ret5);
HXLINE( 423)					 ::zpp_nape::util::ZNPList_ZPP_SimplifyP _hx_tmp4 = ::zpp_nape::geom::ZPP_Simplify_obj::stack;
HXDLIN( 423)					 ::zpp_nape::geom::ZPP_SimplifyP ret6;
...
HXDLIN( 423)					_hx_tmp4->add(ret6);
            				}
            				else {
HXLINE( 426)					max->flag = (fst->flag = true);
HXLINE( 427)					 ::zpp_nape::util::ZNPList_ZPP_SimplifyP _hx_tmp5 = ::zpp_nape::geom::ZPP_Simplify_obj::stack;
HXDLIN( 427)					 ::zpp_nape::geom::ZPP_SimplifyP ret7;
...
HXDLIN( 427)					_hx_tmp5->add(ret7);
HXLINE( 428)					 ::zpp_nape::util::ZNPList_ZPP_SimplifyP _hx_tmp6 = ::zpp_nape::geom::ZPP_Simplify_obj::stack;
HXDLIN( 428)					 ::zpp_nape::geom::ZPP_SimplifyP ret8;
...
HXDLIN( 428)					_hx_tmp6->add(ret8);
            				}
            			}
            		}
            		else {
HXLINE( 432)			 ::zpp_nape::util::ZNPList_ZPP_SimplifyP _hx_tmp7 = ::zpp_nape::geom::ZPP_Simplify_obj::stack;
HXDLIN( 432)			 ::zpp_nape::geom::ZPP_SimplifyP ret9;
...
HXLINE( 437)			{
HXLINE( 438)				 ::zpp_nape::geom::ZPP_SimplifyP o = cur1;
HXLINE( 447)				o->min = (o->max = null());
HXLINE( 448)				o->next = ::zpp_nape::geom::ZPP_SimplifyP_obj::zpp_pool;
HXLINE( 449)				::zpp_nape::geom::ZPP_SimplifyP_obj::zpp_pool = o;
            			}
...
HXLINE( 467)				 ::zpp_nape::util::ZNPList_ZPP_SimplifyP _hx_tmp8 = ::zpp_nape::geom::ZPP_Simplify_obj::stack;
HXDLIN( 467)				 ::zpp_nape::geom::ZPP_SimplifyP ret10;
...
HXDLIN( 467)				_hx_tmp8->add(ret10);
HXLINE( 468)				 ::zpp_nape::util::ZNPList_ZPP_SimplifyP _hx_tmp9 = ::zpp_nape::geom::ZPP_Simplify_obj::stack;
HXDLIN( 468)				 ::zpp_nape::geom::ZPP_SimplifyP ret11;
...
HXDLIN( 468)				_hx_tmp9->add(ret11);
            			}
            		}
HXLINE( 471)		 ::zpp_nape::geom::ZPP_GeomVert retp = null();
HXLINE( 472)		while(hx::IsNotNull( ret )){
HXLINE( 473)			if (ret->flag) {
HXLINE( 475)				Float x = ret->x;
HXDLIN( 475)				Float y = ret->y;
HXDLIN( 475)				 ::zpp_nape::geom::ZPP_GeomVert ret12;
HXDLIN( 475)				{
...
HXDLIN( 475)				{
HXLINE( 475)					ret12->x = x;
HXDLIN( 475)					ret12->y = y;
            				}
HXDLIN( 475)				 ::zpp_nape::geom::ZPP_GeomVert obj1 = ret12;
HXLINE( 476)				if (hx::IsNull( retp )) {
HXLINE( 476)					retp = (obj1->prev = (obj1->next = obj1));
            				}
            				else {
HXLINE( 478)					obj1->prev = retp;
HXLINE( 479)					obj1->next = retp->next;
HXLINE( 480)					retp->next->prev = obj1;
HXLINE( 481)					retp->next = obj1;
            				}
HXLINE( 483)				retp = obj1;
HXLINE( 485)				retp->forced = ret->forced;
            			}
...
HXLINE( 498)				{
HXLINE( 499)					 ::zpp_nape::geom::ZPP_SimplifyV o1 = ret;
HXLINE( 509)					o1->next = ::zpp_nape::geom::ZPP_SimplifyV_obj::zpp_pool;
HXLINE( 510)					::zpp_nape::geom::ZPP_SimplifyV_obj::zpp_pool = o1;
            				}
HXLINE( 515)				ret = null();
HXDLIN( 515)				ret = ret;
            			}
...
HXLINE( 522)				{
HXLINE( 523)					 ::zpp_nape::geom::ZPP_SimplifyV o2 = ret;
HXLINE( 533)					o2->next = ::zpp_nape::geom::ZPP_SimplifyV_obj::zpp_pool;
HXLINE( 534)					::zpp_nape::geom::ZPP_SimplifyV_obj::zpp_pool = o2;
            				}
HXLINE( 539)				ret = null();
