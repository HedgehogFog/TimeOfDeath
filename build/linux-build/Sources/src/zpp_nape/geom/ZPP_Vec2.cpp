...
HXDLIN( 296)		 ::zpp_nape::geom::ZPP_Vec2 temp = o;
HXDLIN( 296)		temp->next = this->next;
HXDLIN( 296)		this->next = temp;
...
HXLINE( 309)		 ::zpp_nape::geom::ZPP_Vec2 temp = o;
HXLINE( 313)		temp->next = this->next;
HXLINE( 314)		this->next = temp;
...
HXLINE( 331)			 ::zpp_nape::geom::ZPP_Vec2 i = cx_ite;
HXLINE( 332)			this->add(i);
...
HXDLIN( 338)		 ::zpp_nape::geom::ZPP_Vec2 temp = o;
HXDLIN( 338)		if (hx::IsNull( cur )) {
HXDLIN( 338)			temp->next = this->next;
HXDLIN( 338)			this->next = temp;
            		}
            		else {
HXDLIN( 338)			temp->next = cur->next;
HXDLIN( 338)			cur->next = temp;
            		}
HXDLIN( 338)		this->pushmod = (this->modified = true);
HXDLIN( 338)		this->length++;
HXDLIN( 338)		return temp;
            	}
...
HXLINE( 351)		 ::zpp_nape::geom::ZPP_Vec2 temp = o;
HXLINE( 355)		if (hx::IsNull( cur )) {
HXLINE( 356)			temp->next = this->next;
HXLINE( 357)			this->next = temp;
            		}
            		else {
HXLINE( 360)			temp->next = cur->next;
HXLINE( 361)			cur->next = temp;
            		}
HXLINE( 363)		this->pushmod = (this->modified = true);
HXLINE( 364)		this->length++;
HXLINE( 365)		return temp;
            	}
...
HXDLIN( 418)		bool ret = false;
HXDLIN( 418)		while(hx::IsNotNull( cur )){
HXDLIN( 418)			if (hx::IsEq( cur,obj )) {
HXDLIN( 418)				{
HXDLIN( 418)					 ::zpp_nape::geom::ZPP_Vec2 old;
HXDLIN( 418)					 ::zpp_nape::geom::ZPP_Vec2 ret1;
HXDLIN( 418)					if (hx::IsNull( pre )) {
HXDLIN( 418)						old = this->next;
HXDLIN( 418)						ret1 = old->next;
HXDLIN( 418)						this->next = ret1;
...
HXDLIN( 418)						ret1 = old->next;
HXDLIN( 418)						pre->next = ret1;
HXDLIN( 418)						if (hx::IsNull( ret1 )) {
HXDLIN( 418)							this->pushmod = true;
            						}
            					}
...
HXDLIN( 454)		bool ret = false;
HXDLIN( 454)		while(hx::IsNotNull( cur )){
HXDLIN( 454)			if (hx::IsEq( cur,obj )) {
HXDLIN( 454)				{
HXDLIN( 454)					 ::zpp_nape::geom::ZPP_Vec2 old;
HXDLIN( 454)					 ::zpp_nape::geom::ZPP_Vec2 ret1;
HXDLIN( 454)					if (hx::IsNull( pre )) {
HXDLIN( 454)						old = this->next;
HXDLIN( 454)						ret1 = old->next;
HXDLIN( 454)						this->next = ret1;
...
HXDLIN( 454)						ret1 = old->next;
HXDLIN( 454)						pre->next = ret1;
HXDLIN( 454)						if (hx::IsNull( ret1 )) {
HXDLIN( 454)							this->pushmod = true;
            						}
            					}
...
HXDLIN( 557)					 ::zpp_nape::geom::ZPP_Vec2 npite = cx_ite;
HXDLIN( 557)					if (hx::IsEq( npite,obj )) {
HXDLIN( 557)						ret = true;
...
HXLINE( 576)					 ::zpp_nape::geom::ZPP_Vec2 npite = cx_ite;
HXLINE( 578)					if (hx::IsEq( npite,obj )) {
HXLINE( 579)						ret = true;
