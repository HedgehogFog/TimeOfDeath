...
HXDLIN( 322)		Float minx = this->minx;
HXDLIN( 322)		Float miny = this->miny;
HXDLIN( 322)		Float maxx = this->maxx;
HXDLIN( 322)		Float maxy = this->maxy;
...
HXDLIN( 322)		{
HXDLIN( 322)			ret->minx = minx;
HXDLIN( 322)			ret->miny = miny;
            		}
HXDLIN( 322)		{
HXDLIN( 322)			ret->maxx = maxx;
HXDLIN( 322)			ret->maxy = maxy;
            		}
...
HXDLIN( 344)				if (hx::IsEq( ret,::zpp_nape::util::ZPP_PubPool_obj::nextVec2 )) {
...
HXDLIN( 409)				if (hx::IsEq( ret,::zpp_nape::util::ZPP_PubPool_obj::nextVec2 )) {
