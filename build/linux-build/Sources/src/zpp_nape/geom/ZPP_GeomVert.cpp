...
HXDLIN( 209)				{
HXLINE( 209)					 ::nape::geom::Vec2 o = _this;
HXDLIN( 209)					o->zpp_pool = null();
HXDLIN( 209)					if (hx::IsNotNull( ::zpp_nape::util::ZPP_PubPool_obj::nextVec2 )) {
HXLINE( 209)						::zpp_nape::util::ZPP_PubPool_obj::nextVec2->zpp_pool = o;
            					}
            					else {
HXLINE( 209)						::zpp_nape::util::ZPP_PubPool_obj::poolVec2 = o;
            					}
HXDLIN( 209)					::zpp_nape::util::ZPP_PubPool_obj::nextVec2 = o;
HXDLIN( 209)					o->zpp_disp = true;
            				}
HXDLIN( 209)				{
HXLINE( 209)					 ::zpp_nape::geom::ZPP_Vec2 o1 = inner;
HXDLIN( 209)					{
HXLINE( 209)						if (hx::IsNotNull( o1->outer )) {
HXLINE( 209)							o1->outer->zpp_inner = null();
HXDLIN( 209)							o1->outer = null();
            						}
HXDLIN( 209)						o1->_isimmutable = null();
HXDLIN( 209)						o1->_validate = null();
HXDLIN( 209)						o1->_invalidate = null();
            					}
HXDLIN( 209)					o1->next = ::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool;
HXDLIN( 209)					::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool = o1;
            				}
            			}
...
HXDLIN( 221)				if (hx::IsEq( ret,::zpp_nape::util::ZPP_PubPool_obj::nextVec2 )) {
