...
HXLINE( 842)		{
HXLINE( 843)			 ::zpp_nape::geom::ZPP_GeomVert F = poly;
HXLINE( 844)			 ::zpp_nape::geom::ZPP_GeomVert L = poly;
HXLINE( 845)			if (hx::IsNotNull( F )) {
HXLINE( 846)				 ::zpp_nape::geom::ZPP_GeomVert nite = F;
...
HXLINE( 847)					if (!(hx::IsNotEq( nite,L ))) {
...
HXLINE(1007)									 ::zpp_nape::util::FastHash2_Hashable2_Boolfalse _hx_tmp3 = ::zpp_nape::geom::ZPP_Simple_obj::inthash;
HXDLIN(1007)									int id = s->next->id;
...
HXDLIN(1007)									_hx_tmp3->add(ret6);
            								}
            								else {
HXLINE(1008)									 ::zpp_nape::util::FastHash2_Hashable2_Boolfalse _hx_tmp4 = ::zpp_nape::geom::ZPP_Simple_obj::inthash;
HXDLIN(1008)									int id1 = s->id;
HXDLIN(1008)									int di1 = s->next->id;
...
HXDLIN(1008)									ret7->id = id1;
HXDLIN(1008)									ret7->di = di1;
HXDLIN(1008)									 ::zpp_nape::util::Hashable2_Boolfalse ret8 = ret7;
HXDLIN(1008)									ret8->value = true;
HXDLIN(1008)									_hx_tmp4->add(ret8);
            								}
            							}
            							else {
HXLINE(1011)								 ::zpp_nape::geom::ZPP_SimpleEvent x1 = ex->data;
HXLINE(1013)								bool _hx_tmp5;
HXDLIN(1013)								if (hx::IsEq( x1->segment,intx->segment )) {
HXLINE(1013)									_hx_tmp5 = hx::IsNotEq( intx->segment2,x1->segment2 );
            								}
            								else {
HXLINE(1013)									_hx_tmp5 = true;
            								}
HXDLIN(1013)								if (_hx_tmp5) {
...
HXLINE(1032)								{
HXLINE(1033)									 ::zpp_nape::geom::ZPP_SimpleEvent o3 = intx;
HXLINE(1042)									{
HXLINE(1042)										o3->vertex = null();
HXDLIN(1042)										o3->segment = (o3->segment2 = null());
HXDLIN(1042)										o3->node = null();
            									}
HXLINE(1043)									o3->next = ::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool;
HXLINE(1044)									::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool = o3;
            								}
            							}
            						}
            						else {
HXLINE(1052)							{
HXLINE(1053)								 ::zpp_nape::geom::ZPP_SimpleVert o4 = intx->vertex;
HXLINE(1062)								{
HXLINE(1062)									o4->links->clear();
HXDLIN(1062)									o4->node = null();
HXDLIN(1062)									o4->forced = false;
            								}
HXLINE(1063)								o4->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(1064)								::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o4;
            							}
HXLINE(1069)							{
HXLINE(1070)								 ::zpp_nape::geom::ZPP_SimpleEvent o5 = intx;
HXLINE(1079)								{
HXLINE(1079)									o5->vertex = null();
HXDLIN(1079)									o5->segment = (o5->segment2 = null());
HXDLIN(1079)									o5->node = null();
            								}
HXLINE(1080)								o5->next = ::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool;
HXLINE(1081)								::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool = o5;
            							}
            						}
            					}
            				}
HXLINE(1091)				bool _hx_tmp6;
HXDLIN(1091)				bool _hx_tmp7;
HXDLIN(1091)				if (hx::IsNotNull( s )) {
HXLINE(1091)					_hx_tmp7 = hx::IsNotNull( s->prev );
            				}
            				else {
HXLINE(1091)					_hx_tmp7 = false;
            				}
HXDLIN(1091)				if (_hx_tmp7) {
HXLINE(1091)					bool _hx_tmp8;
HXDLIN(1091)					if ((s->id < s->prev->id)) {
HXLINE(1091)						_hx_tmp8 = ::zpp_nape::geom::ZPP_Simple_obj::inthash->has(s->id,s->prev->id);
            					}
            					else {
HXLINE(1091)						_hx_tmp8 = ::zpp_nape::geom::ZPP_Simple_obj::inthash->has(s->prev->id,s->id);
            					}
HXDLIN(1091)					_hx_tmp6 = !(_hx_tmp8);
            				}
            				else {
HXLINE(1091)					_hx_tmp6 = false;
            				}
HXDLIN(1091)				if (_hx_tmp6) {
...
HXLINE(1115)									{
HXLINE(1116)										 ::zpp_nape::geom::ZPP_SimpleVert o6 = intx1->vertex;
HXLINE(1125)										{
HXLINE(1125)											o6->links->clear();
HXDLIN(1125)											o6->node = null();
HXDLIN(1125)											o6->forced = false;
            										}
HXLINE(1126)										o6->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(1127)										::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o6;
            									}
...
HXLINE(1140)									 ::zpp_nape::util::FastHash2_Hashable2_Boolfalse _hx_tmp9 = ::zpp_nape::geom::ZPP_Simple_obj::inthash;
HXDLIN(1140)									int id2 = s->id;
HXDLIN(1140)									int di2 = s->prev->id;
...
HXDLIN(1140)									ret9->id = id2;
HXDLIN(1140)									ret9->di = di2;
HXDLIN(1140)									 ::zpp_nape::util::Hashable2_Boolfalse ret10 = ret9;
HXDLIN(1140)									ret10->value = true;
HXDLIN(1140)									_hx_tmp9->add(ret10);
            								}
            								else {
HXLINE(1141)									 ::zpp_nape::util::FastHash2_Hashable2_Boolfalse _hx_tmp10 = ::zpp_nape::geom::ZPP_Simple_obj::inthash;
HXDLIN(1141)									int id3 = s->prev->id;
HXDLIN(1141)									int di3 = s->id;
...
HXDLIN(1141)									ret11->id = id3;
HXDLIN(1141)									ret11->di = di3;
HXDLIN(1141)									 ::zpp_nape::util::Hashable2_Boolfalse ret12 = ret11;
HXDLIN(1141)									ret12->value = true;
HXDLIN(1141)									_hx_tmp10->add(ret12);
            								}
            							}
            							else {
HXLINE(1144)								 ::zpp_nape::geom::ZPP_SimpleEvent x2 = ex1->data;
HXLINE(1146)								bool _hx_tmp11;
HXDLIN(1146)								if (hx::IsEq( x2->segment,intx1->segment )) {
HXLINE(1146)									_hx_tmp11 = hx::IsNotEq( intx1->segment2,x2->segment2 );
            								}
            								else {
HXLINE(1146)									_hx_tmp11 = true;
            								}
HXDLIN(1146)								if (_hx_tmp11) {
HXLINE(1146)									HX_STACK_DO_THROW(HX_("corner case 2, shiiiit.",b0,6f,0e,6b));
            								}
HXLINE(1148)								{
HXLINE(1149)									 ::zpp_nape::geom::ZPP_SimpleVert o7 = intx1->vertex;
HXLINE(1158)									{
HXLINE(1158)										o7->links->clear();
HXDLIN(1158)										o7->node = null();
HXDLIN(1158)										o7->forced = false;
            									}
HXLINE(1159)									o7->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(1160)									::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o7;
            								}
HXLINE(1165)								{
HXLINE(1166)									 ::zpp_nape::geom::ZPP_SimpleEvent o8 = intx1;
HXLINE(1175)									{
HXLINE(1175)										o8->vertex = null();
HXDLIN(1175)										o8->segment = (o8->segment2 = null());
HXDLIN(1175)										o8->node = null();
            									}
HXLINE(1176)									o8->next = ::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool;
HXLINE(1177)									::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool = o8;
            								}
            							}
            						}
            						else {
HXLINE(1185)							{
HXLINE(1186)								 ::zpp_nape::geom::ZPP_SimpleVert o9 = intx1->vertex;
HXLINE(1195)								{
HXLINE(1195)									o9->links->clear();
HXDLIN(1195)									o9->node = null();
HXDLIN(1195)									o9->forced = false;
            								}
HXLINE(1196)								o9->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(1197)								::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o9;
            							}
HXLINE(1202)							{
HXLINE(1203)								 ::zpp_nape::geom::ZPP_SimpleEvent o10 = intx1;
HXLINE(1212)								{
HXLINE(1212)									o10->vertex = null();
HXDLIN(1212)									o10->segment = (o10->segment2 = null());
HXDLIN(1212)									o10->node = null();
            								}
HXLINE(1213)								o10->next = ::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool;
HXLINE(1214)								::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool = o10;
            							}
            						}
            					}
            				}
...
HXLINE(1230)						{
HXLINE(1231)							 ::zpp_nape::geom::ZPP_SimpleSeg o11 = s1;
HXLINE(1240)							{
HXLINE(1240)								o11->left = (o11->right = null());
HXDLIN(1240)								o11->prev = null();
HXDLIN(1240)								o11->node = null();
HXDLIN(1240)								o11->vertices->clear();
            							}
HXLINE(1241)							o11->next = ::zpp_nape::geom::ZPP_SimpleSeg_obj::zpp_pool;
HXLINE(1242)							::zpp_nape::geom::ZPP_SimpleSeg_obj::zpp_pool = o11;
            						}
HXLINE(1248)						bool _hx_tmp12;
HXDLIN(1248)						bool _hx_tmp13;
HXDLIN(1248)						if (hx::IsNotNull( nxt )) {
HXLINE(1248)							_hx_tmp13 = hx::IsNotNull( pre1 );
            						}
            						else {
HXLINE(1248)							_hx_tmp13 = false;
            						}
HXDLIN(1248)						if (_hx_tmp13) {
HXLINE(1248)							bool _hx_tmp14;
HXDLIN(1248)							if ((nxt->id < pre1->id)) {
HXLINE(1248)								_hx_tmp14 = ::zpp_nape::geom::ZPP_Simple_obj::inthash->has(nxt->id,pre1->id);
            							}
            							else {
HXLINE(1248)								_hx_tmp14 = ::zpp_nape::geom::ZPP_Simple_obj::inthash->has(pre1->id,nxt->id);
            							}
HXDLIN(1248)							_hx_tmp12 = !(_hx_tmp14);
            						}
            						else {
HXLINE(1248)							_hx_tmp12 = false;
            						}
HXDLIN(1248)						if (_hx_tmp12) {
...
HXLINE(1272)											{
HXLINE(1273)												 ::zpp_nape::geom::ZPP_SimpleVert o12 = intx2->vertex;
HXLINE(1282)												{
HXLINE(1282)													o12->links->clear();
HXDLIN(1282)													o12->node = null();
HXDLIN(1282)													o12->forced = false;
            												}
HXLINE(1283)												o12->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(1284)												::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o12;
            											}
...
HXLINE(1297)											 ::zpp_nape::util::FastHash2_Hashable2_Boolfalse _hx_tmp15 = ::zpp_nape::geom::ZPP_Simple_obj::inthash;
HXDLIN(1297)											int id4 = nxt->id;
HXDLIN(1297)											int di4 = pre1->id;
...
HXDLIN(1297)											ret13->id = id4;
HXDLIN(1297)											ret13->di = di4;
HXDLIN(1297)											 ::zpp_nape::util::Hashable2_Boolfalse ret14 = ret13;
HXDLIN(1297)											ret14->value = true;
HXDLIN(1297)											_hx_tmp15->add(ret14);
            										}
            										else {
HXLINE(1298)											 ::zpp_nape::util::FastHash2_Hashable2_Boolfalse _hx_tmp16 = ::zpp_nape::geom::ZPP_Simple_obj::inthash;
HXDLIN(1298)											int id5 = pre1->id;
HXDLIN(1298)											int di5 = nxt->id;
...
HXDLIN(1298)											ret15->id = id5;
HXDLIN(1298)											ret15->di = di5;
HXDLIN(1298)											 ::zpp_nape::util::Hashable2_Boolfalse ret16 = ret15;
HXDLIN(1298)											ret16->value = true;
HXDLIN(1298)											_hx_tmp16->add(ret16);
            										}
            									}
            									else {
HXLINE(1301)										 ::zpp_nape::geom::ZPP_SimpleEvent x3 = ex2->data;
HXLINE(1303)										bool _hx_tmp17;
HXDLIN(1303)										if (hx::IsEq( x3->segment,intx2->segment )) {
HXLINE(1303)											_hx_tmp17 = hx::IsNotEq( intx2->segment2,x3->segment2 );
            										}
            										else {
HXLINE(1303)											_hx_tmp17 = true;
            										}
HXDLIN(1303)										if (_hx_tmp17) {
HXLINE(1303)											HX_STACK_DO_THROW(HX_("corner case 2, shiiiit.",b0,6f,0e,6b));
            										}
HXLINE(1305)										{
HXLINE(1306)											 ::zpp_nape::geom::ZPP_SimpleVert o13 = intx2->vertex;
HXLINE(1315)											{
HXLINE(1315)												o13->links->clear();
HXDLIN(1315)												o13->node = null();
HXDLIN(1315)												o13->forced = false;
            											}
HXLINE(1316)											o13->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(1317)											::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o13;
            										}
HXLINE(1322)										{
HXLINE(1323)											 ::zpp_nape::geom::ZPP_SimpleEvent o14 = intx2;
HXLINE(1332)											{
HXLINE(1332)												o14->vertex = null();
HXDLIN(1332)												o14->segment = (o14->segment2 = null());
HXDLIN(1332)												o14->node = null();
            											}
HXLINE(1333)											o14->next = ::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool;
HXLINE(1334)											::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool = o14;
            										}
            									}
            								}
            								else {
HXLINE(1342)									{
HXLINE(1343)										 ::zpp_nape::geom::ZPP_SimpleVert o15 = intx2->vertex;
HXLINE(1352)										{
HXLINE(1352)											o15->links->clear();
HXDLIN(1352)											o15->node = null();
HXDLIN(1352)											o15->forced = false;
            										}
HXLINE(1353)										o15->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(1354)										::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o15;
            									}
HXLINE(1359)									{
HXLINE(1360)										 ::zpp_nape::geom::ZPP_SimpleEvent o16 = intx2;
HXLINE(1369)										{
HXLINE(1369)											o16->vertex = null();
HXDLIN(1369)											o16->segment = (o16->segment2 = null());
HXDLIN(1369)											o16->node = null();
            										}
HXLINE(1370)										o16->next = ::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool;
HXLINE(1371)										::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool = o16;
            									}
            								}
            							}
            						}
...
HXLINE(1414)								goto _hx_goto_10;
            					...
            					_hx_goto_10:;
HXLINE(1409)					bool bnew = hx::IsNull( cur8 );
HXLINE(1418)					if (anew) {
...
HXLINE(1457)					bool _hx_tmp18;
HXDLIN(1457)					bool _hx_tmp19;
HXDLIN(1457)					if (hx::IsNotNull( b->next )) {
HXLINE(1457)						_hx_tmp19 = hx::IsNotNull( b );
            					}
            					else {
HXLINE(1457)						_hx_tmp19 = false;
            					}
HXDLIN(1457)					if (_hx_tmp19) {
HXLINE(1457)						bool _hx_tmp20;
HXDLIN(1457)						if ((b->next->id < b->id)) {
HXLINE(1457)							_hx_tmp20 = ::zpp_nape::geom::ZPP_Simple_obj::inthash->has(b->next->id,b->id);
            						}
            						else {
HXLINE(1457)							_hx_tmp20 = ::zpp_nape::geom::ZPP_Simple_obj::inthash->has(b->id,b->next->id);
            						}
HXDLIN(1457)						_hx_tmp18 = !(_hx_tmp20);
            					}
            					else {
HXLINE(1457)						_hx_tmp18 = false;
            					}
HXDLIN(1457)					if (_hx_tmp18) {
...
HXLINE(1481)										{
HXLINE(1482)											 ::zpp_nape::geom::ZPP_SimpleVert o17 = intx4->vertex;
HXLINE(1491)											{
HXLINE(1491)												o17->links->clear();
HXDLIN(1491)												o17->node = null();
HXDLIN(1491)												o17->forced = false;
            											}
HXLINE(1492)											o17->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(1493)											::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o17;
            										}
...
HXLINE(1506)										 ::zpp_nape::util::FastHash2_Hashable2_Boolfalse _hx_tmp21 = ::zpp_nape::geom::ZPP_Simple_obj::inthash;
HXDLIN(1506)										int id6 = b->next->id;
...
HXDLIN(1506)										ret17->id = id6;
HXDLIN(1506)										ret17->di = di6;
HXDLIN(1506)										 ::zpp_nape::util::Hashable2_Boolfalse ret18 = ret17;
HXDLIN(1506)										ret18->value = true;
HXDLIN(1506)										_hx_tmp21->add(ret18);
            									}
            									else {
HXLINE(1507)										 ::zpp_nape::util::FastHash2_Hashable2_Boolfalse _hx_tmp22 = ::zpp_nape::geom::ZPP_Simple_obj::inthash;
HXDLIN(1507)										int id7 = b->id;
HXDLIN(1507)										int di7 = b->next->id;
...
HXDLIN(1507)										ret19->id = id7;
HXDLIN(1507)										ret19->di = di7;
HXDLIN(1507)										 ::zpp_nape::util::Hashable2_Boolfalse ret20 = ret19;
HXDLIN(1507)										ret20->value = true;
HXDLIN(1507)										_hx_tmp22->add(ret20);
            									}
            								}
            								else {
HXLINE(1510)									 ::zpp_nape::geom::ZPP_SimpleEvent x4 = ex3->data;
HXLINE(1512)									bool _hx_tmp23;
HXDLIN(1512)									if (hx::IsEq( x4->segment,intx4->segment )) {
HXLINE(1512)										_hx_tmp23 = hx::IsNotEq( intx4->segment2,x4->segment2 );
            									}
            									else {
HXLINE(1512)										_hx_tmp23 = true;
            									}
HXDLIN(1512)									if (_hx_tmp23) {
HXLINE(1512)										HX_STACK_DO_THROW(HX_("corner case 2, shiiiit.",b0,6f,0e,6b));
            									}
HXLINE(1514)									{
HXLINE(1515)										 ::zpp_nape::geom::ZPP_SimpleVert o18 = intx4->vertex;
HXLINE(1524)										{
HXLINE(1524)											o18->links->clear();
HXDLIN(1524)											o18->node = null();
HXDLIN(1524)											o18->forced = false;
            										}
HXLINE(1525)										o18->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(1526)										::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o18;
            									}
HXLINE(1531)									{
HXLINE(1532)										 ::zpp_nape::geom::ZPP_SimpleEvent o19 = intx4;
HXLINE(1541)										{
HXLINE(1541)											o19->vertex = null();
HXDLIN(1541)											o19->segment = (o19->segment2 = null());
HXDLIN(1541)											o19->node = null();
            										}
HXLINE(1542)										o19->next = ::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool;
HXLINE(1543)										::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool = o19;
            									}
            								}
            							}
            							else {
HXLINE(1551)								{
HXLINE(1552)									 ::zpp_nape::geom::ZPP_SimpleVert o20 = intx4->vertex;
HXLINE(1561)									{
HXLINE(1561)										o20->links->clear();
HXDLIN(1561)										o20->node = null();
HXDLIN(1561)										o20->forced = false;
            									}
HXLINE(1562)									o20->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(1563)									::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o20;
            								}
HXLINE(1568)								{
HXLINE(1569)									 ::zpp_nape::geom::ZPP_SimpleEvent o21 = intx4;
HXLINE(1578)									{
HXLINE(1578)										o21->vertex = null();
HXDLIN(1578)										o21->segment = (o21->segment2 = null());
HXDLIN(1578)										o21->node = null();
            									}
HXLINE(1579)									o21->next = ::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool;
HXLINE(1580)									::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool = o21;
            								}
            							}
            						}
            					}
HXLINE(1590)					bool _hx_tmp24;
HXDLIN(1590)					bool _hx_tmp25;
HXDLIN(1590)					if (hx::IsNotNull( a )) {
HXLINE(1590)						_hx_tmp25 = hx::IsNotNull( a->prev );
            					}
            					else {
HXLINE(1590)						_hx_tmp25 = false;
            					}
HXDLIN(1590)					if (_hx_tmp25) {
HXLINE(1590)						bool _hx_tmp26;
HXDLIN(1590)						if ((a->id < a->prev->id)) {
HXLINE(1590)							_hx_tmp26 = ::zpp_nape::geom::ZPP_Simple_obj::inthash->has(a->id,a->prev->id);
            						}
            						else {
HXLINE(1590)							_hx_tmp26 = ::zpp_nape::geom::ZPP_Simple_obj::inthash->has(a->prev->id,a->id);
            						}
HXDLIN(1590)						_hx_tmp24 = !(_hx_tmp26);
            					}
            					else {
HXLINE(1590)						_hx_tmp24 = false;
            					}
HXDLIN(1590)					if (_hx_tmp24) {
...
HXLINE(1614)										{
HXLINE(1615)											 ::zpp_nape::geom::ZPP_SimpleVert o22 = intx5->vertex;
HXLINE(1624)											{
HXLINE(1624)												o22->links->clear();
HXDLIN(1624)												o22->node = null();
HXDLIN(1624)												o22->forced = false;
            											}
HXLINE(1625)											o22->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(1626)											::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o22;
            										}
...
HXLINE(1639)										 ::zpp_nape::util::FastHash2_Hashable2_Boolfalse _hx_tmp27 = ::zpp_nape::geom::ZPP_Simple_obj::inthash;
HXDLIN(1639)										int id8 = a->id;
HXDLIN(1639)										int di8 = a->prev->id;
...
HXDLIN(1639)										ret21->id = id8;
HXDLIN(1639)										ret21->di = di8;
HXDLIN(1639)										 ::zpp_nape::util::Hashable2_Boolfalse ret22 = ret21;
HXDLIN(1639)										ret22->value = true;
HXDLIN(1639)										_hx_tmp27->add(ret22);
            									}
            									else {
HXLINE(1640)										 ::zpp_nape::util::FastHash2_Hashable2_Boolfalse _hx_tmp28 = ::zpp_nape::geom::ZPP_Simple_obj::inthash;
HXDLIN(1640)										int id9 = a->prev->id;
HXDLIN(1640)										int di9 = a->id;
...
HXDLIN(1640)										ret23->id = id9;
HXDLIN(1640)										ret23->di = di9;
HXDLIN(1640)										 ::zpp_nape::util::Hashable2_Boolfalse ret24 = ret23;
HXDLIN(1640)										ret24->value = true;
HXDLIN(1640)										_hx_tmp28->add(ret24);
            									}
            								}
            								else {
HXLINE(1643)									 ::zpp_nape::geom::ZPP_SimpleEvent x5 = ex4->data;
HXLINE(1645)									bool _hx_tmp29;
HXDLIN(1645)									if (hx::IsEq( x5->segment,intx5->segment )) {
HXLINE(1645)										_hx_tmp29 = hx::IsNotEq( intx5->segment2,x5->segment2 );
            									}
            									else {
HXLINE(1645)										_hx_tmp29 = true;
            									}
HXDLIN(1645)									if (_hx_tmp29) {
HXLINE(1645)										HX_STACK_DO_THROW(HX_("corner case 2, shiiiit.",b0,6f,0e,6b));
            									}
HXLINE(1647)									{
HXLINE(1648)										 ::zpp_nape::geom::ZPP_SimpleVert o23 = intx5->vertex;
HXLINE(1657)										{
HXLINE(1657)											o23->links->clear();
HXDLIN(1657)											o23->node = null();
HXDLIN(1657)											o23->forced = false;
            										}
HXLINE(1658)										o23->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(1659)										::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o23;
            									}
HXLINE(1664)									{
HXLINE(1665)										 ::zpp_nape::geom::ZPP_SimpleEvent o24 = intx5;
HXLINE(1674)										{
HXLINE(1674)											o24->vertex = null();
HXDLIN(1674)											o24->segment = (o24->segment2 = null());
HXDLIN(1674)											o24->node = null();
            										}
HXLINE(1675)										o24->next = ::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool;
HXLINE(1676)										::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool = o24;
            									}
            								}
            							}
            							else {
HXLINE(1684)								{
HXLINE(1685)									 ::zpp_nape::geom::ZPP_SimpleVert o25 = intx5->vertex;
HXLINE(1694)									{
HXLINE(1694)										o25->links->clear();
HXDLIN(1694)										o25->node = null();
HXDLIN(1694)										o25->forced = false;
            									}
HXLINE(1695)									o25->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(1696)									::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o25;
            								}
HXLINE(1701)								{
HXLINE(1702)									 ::zpp_nape::geom::ZPP_SimpleEvent o26 = intx5;
HXLINE(1711)									{
HXLINE(1711)										o26->vertex = null();
HXDLIN(1711)										o26->segment = (o26->segment2 = null());
HXDLIN(1711)										o26->node = null();
            									}
HXLINE(1712)									o26->next = ::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool;
HXLINE(1713)									::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool = o26;
            								}
            							}
            						}
            					}
...
HXLINE(1724)			{
HXLINE(1725)				 ::zpp_nape::geom::ZPP_SimpleEvent o27 = e;
HXLINE(1734)				{
HXLINE(1734)					o27->vertex = null();
HXDLIN(1734)					o27->segment = (o27->segment2 = null());
HXDLIN(1734)					o27->node = null();
            				}
HXLINE(1735)				o27->next = ::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool;
HXLINE(1736)				::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool = o27;
            			}
            		}
HXLINE(1759)		{
...
HXLINE(1765)					{
HXLINE(1766)						 ::zpp_nape::util::Hashable2_Boolfalse o28 = n;
HXLINE(1776)						o28->next = ::zpp_nape::util::Hashable2_Boolfalse_obj::zpp_pool;
HXLINE(1777)						::zpp_nape::util::Hashable2_Boolfalse_obj::zpp_pool = o28;
            					}
HXLINE(1782)					n = t1;
            				}
...
HXLINE(1823)		Float x = cur->x;
HXDLIN(1823)		Float y = cur->y;
HXDLIN(1823)		 ::zpp_nape::geom::ZPP_GeomVert ret1;
HXDLIN(1823)		{
...
HXDLIN(1823)		{
HXLINE(1823)			ret1->x = x;
HXDLIN(1823)			ret1->y = y;
            		}
...
HXLINE(1831)		ret = obj;
HXLINE(1833)		ret->forced = cur->forced;
...
HXLINE(1861)			Float x1 = nxt->x;
HXDLIN(1861)			Float y1 = nxt->y;
HXDLIN(1861)			 ::zpp_nape::geom::ZPP_GeomVert ret2;
HXDLIN(1861)			{
...
HXDLIN(1861)			{
HXLINE(1861)				ret2->x = x1;
HXDLIN(1861)				ret2->y = y1;
            			}
...
HXLINE(1871)			ret->forced = nxt->forced;
...
HXLINE(1961)									Float pleft = ((vy3 * ux3) - (vx3 * uy3));
HXLINE(1976)									if ((pleft > 0)) {
HXLINE(1977)										min = p;
...
HXLINE(2028)			{
HXLINE(2029)				 ::zpp_nape::geom::ZPP_SimpleVert o3 = fst;
HXLINE(2038)				{
HXLINE(2038)					o3->links->clear();
HXDLIN(2038)					o3->node = null();
HXDLIN(2038)					o3->forced = false;
            				}
HXLINE(2039)				o3->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(2040)				::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o3;
            			}
            		}
...
HXLINE(2057)		{
HXLINE(2058)			 ::zpp_nape::geom::ZPP_GeomVert F = poly;
HXLINE(2059)			 ::zpp_nape::geom::ZPP_GeomVert L = poly;
HXLINE(2060)			if (hx::IsNotNull( F )) {
HXLINE(2061)				 ::zpp_nape::geom::ZPP_GeomVert nite = F;
...
HXLINE(2062)					if (!(hx::IsNotEq( nite,L ))) {
...
HXLINE(2189)					{
HXLINE(2190)						 ::zpp_nape::geom::ZPP_SimpleSeg o = seg;
HXLINE(2199)						{
HXLINE(2199)							o->left = (o->right = null());
HXDLIN(2199)							o->prev = null();
HXDLIN(2199)							o->node = null();
HXDLIN(2199)							o->vertices->clear();
            						}
HXLINE(2200)						o->next = ::zpp_nape::geom::ZPP_SimpleSeg_obj::zpp_pool;
HXLINE(2201)						::zpp_nape::geom::ZPP_SimpleSeg_obj::zpp_pool = o;
            					}
            				}
            			}
HXLINE(2207)			{
HXLINE(2208)				 ::zpp_nape::geom::ZPP_SimpleEvent o1 = e;
HXLINE(2217)				{
HXLINE(2217)					o1->vertex = null();
HXDLIN(2217)					o1->segment = (o1->segment2 = null());
HXDLIN(2217)					o1->node = null();
            				}
HXLINE(2218)				o1->next = ::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool;
HXLINE(2219)				::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool = o1;
            			}
            		}
            		_hx_goto_31:;
...
HXLINE(2228)				 ::zpp_nape::geom::ZPP_SimpleSeg o2 = e3->segment;
HXLINE(2237)				{
HXLINE(2237)					o2->left = (o2->right = null());
HXDLIN(2237)					o2->prev = null();
HXDLIN(2237)					o2->node = null();
HXDLIN(2237)					o2->vertices->clear();
            				}
HXLINE(2238)				o2->next = ::zpp_nape::geom::ZPP_SimpleSeg_obj::zpp_pool;
HXLINE(2239)				::zpp_nape::geom::ZPP_SimpleSeg_obj::zpp_pool = o2;
            			}
HXLINE(2244)			{
HXLINE(2245)				 ::zpp_nape::geom::ZPP_SimpleEvent o3 = e3;
HXLINE(2254)				{
HXLINE(2254)					o3->vertex = null();
HXDLIN(2254)					o3->segment = (o3->segment2 = null());
HXDLIN(2254)					o3->node = null();
            				}
HXLINE(2255)				o3->next = ::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool;
HXLINE(2256)				::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool = o3;
            			}
            		}
HXLINE(2262)		::zpp_nape::geom::ZPP_Simple_obj::sweep->clear();
HXLINE(2263)		while(hx::IsNotNull( vertices->head )){
HXLINE(2264)			 ::zpp_nape::geom::ZPP_SimpleVert o4 = vertices->pop_unsafe();
HXLINE(2273)			{
HXLINE(2273)				o4->links->clear();
HXDLIN(2273)				o4->node = null();
HXDLIN(2273)				o4->forced = false;
            			}
HXLINE(2274)			o4->next = ::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool;
HXLINE(2275)			::zpp_nape::geom::ZPP_SimpleVert_obj::zpp_pool = o4;
            		}
