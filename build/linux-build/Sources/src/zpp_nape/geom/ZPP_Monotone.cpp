...
HXLINE( 191)		{
HXLINE( 192)			Float d = ((ret1->x * ret1->x) + (ret1->y * ret1->y));
HXLINE( 201)			Float imag = (((Float)1.0) / ::Math_obj::sqrt(d));
HXLINE( 202)			{
HXLINE( 203)				Float t = imag;
HXLINE( 212)				 ::zpp_nape::geom::ZPP_Vec2 ret2 = ret1;
HXDLIN( 212)				ret2->x = (ret2->x * t);
HXLINE( 213)				 ::zpp_nape::geom::ZPP_Vec2 ret3 = ret1;
HXDLIN( 213)				ret3->y = (ret3->y * t);
            			}
            		}
...
HXLINE( 231)						{
HXLINE( 232)							Float t = ((Float)1.0);
HXLINE( 241)							 ::zpp_nape::geom::ZPP_Vec2 po1 = po;
HXDLIN( 241)							po1->x = (po1->x + (p->x * t));
HXLINE( 242)							 ::zpp_nape::geom::ZPP_Vec2 po2 = po;
HXDLIN( 242)							po2->y = (po2->y + (p->y * t));
            						}
HXLINE( 244)						{
HXLINE( 245)							Float t1 = ((Float)1.0);
HXLINE( 254)							 ::zpp_nape::geom::ZPP_Vec2 qo1 = qo;
HXDLIN( 254)							qo1->x = (qo1->x + (q->x * t1));
HXLINE( 255)							 ::zpp_nape::geom::ZPP_Vec2 qo2 = qo;
HXDLIN( 255)							qo2->y = (qo2->y + (q->y * t1));
            						}
HXLINE( 257)						bool ret;
...
HXLINE( 258)						{
HXLINE( 259)							 ::zpp_nape::geom::ZPP_Vec2 o = po;
HXLINE( 268)							{
HXLINE( 268)								if (hx::IsNotNull( o->outer )) {
HXLINE( 268)									o->outer->zpp_inner = null();
HXDLIN( 268)									o->outer = null();
            								}
HXDLIN( 268)								o->_isimmutable = null();
HXDLIN( 268)								o->_validate = null();
HXDLIN( 268)								o->_invalidate = null();
            							}
HXLINE( 269)							o->next = ::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool;
HXLINE( 270)							::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool = o;
            						}
HXLINE( 275)						{
HXLINE( 276)							 ::zpp_nape::geom::ZPP_Vec2 o1 = qo;
HXLINE( 285)							{
HXLINE( 285)								if (hx::IsNotNull( o1->outer )) {
HXLINE( 285)									o1->outer->zpp_inner = null();
HXDLIN( 285)									o1->outer = null();
            								}
HXDLIN( 285)								o1->_isimmutable = null();
HXDLIN( 285)								o1->_validate = null();
HXDLIN( 285)								o1->_invalidate = null();
            							}
HXLINE( 286)							o1->next = ::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool;
HXLINE( 287)							::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool = o1;
            						}
...
HXLINE( 308)			 ::zpp_nape::geom::ZPP_GeomVert L = P;
...
HXLINE( 311)					if (!(hx::IsNotEq( nite,L ))) {
...
HXLINE( 329)			 ::zpp_nape::geom::ZPP_GeomVert L1 = max;
...
HXLINE( 332)					if (!(hx::IsNotEq( nite1,L1 ))) {
...
HXLINE( 354)			 ::zpp_nape::geom::ZPP_GeomVert L2 = max;
...
HXLINE( 357)					if (!(hx::IsNotEq( nite2,L2 ))) {
