...
HXLINE( 818)					 ::zpp_nape::geom::ZPP_PartitionVertex p3 = cx_ite2->elt;
HXLINE( 820)					if (hx::IsEq( p3,C )) {
...
HXLINE( 838)					 ::zpp_nape::geom::ZPP_PartitionVertex p4 = cx_ite3->elt;
HXLINE( 840)					if (hx::IsEq( p4,A )) {
...
HXLINE( 851)			{
HXLINE( 852)				 ::zpp_nape::geom::ZPP_PartitionPair o = edge1;
HXLINE( 861)				{
HXLINE( 861)					o->a = (o->b = null());
HXDLIN( 861)					o->node = null();
            				}
HXLINE( 862)				o->next = ::zpp_nape::geom::ZPP_PartitionPair_obj::zpp_pool;
HXLINE( 863)				::zpp_nape::geom::ZPP_PartitionPair_obj::zpp_pool = o;
            			}
            		}
HXLINE( 869)		{
HXLINE( 870)			 ::zpp_nape::geom::ZPP_PartitionPair o1 = edgeStack;
HXLINE( 879)			{
HXLINE( 879)				o1->a = (o1->b = null());
HXDLIN( 879)				o1->node = null();
            			}
HXLINE( 880)			o1->next = ::zpp_nape::geom::ZPP_PartitionPair_obj::zpp_pool;
HXLINE( 881)			::zpp_nape::geom::ZPP_PartitionPair_obj::zpp_pool = o1;
            		}
            	}
