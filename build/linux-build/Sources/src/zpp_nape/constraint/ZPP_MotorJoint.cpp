...
HXLINE( 241)			 ::nape::phys::Body b2 = null();
HXLINE( 242)			{
...
HXLINE( 403)		Float E = ((((this->ratio * (this->b2->angvel + this->b2->kinangvel)) - this->b1->angvel) - this->b1->kinangvel) - this->rate);
HXLINE( 406)		Float j = (-(this->kMass) * E);
HXLINE( 407)		{
