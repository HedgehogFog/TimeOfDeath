...
HXLINE( 365)			 ::nape::phys::Body b2 = null();
HXLINE( 366)			{
...
HXLINE( 711)				Float A = (det * ((this->kMassd * this->kMassf) - (this->kMasse * this->kMasse)));
HXLINE( 712)				Float B = (det * ((this->kMasse * this->kMassc) - (this->kMassb * this->kMassf)));
...
HXLINE( 717)				{
HXLINE( 718)					this->kMassa = A;
HXLINE( 719)					this->kMassb = B;
...
HXLINE( 968)			{
HXLINE( 969)				Float t1 = t;
HXLINE( 978)				Jx = (Jx - (this->jAccx * t1));
HXLINE( 979)				Jy = (Jy - (this->jAccy * t1));
            			}
...
HXLINE(1110)		{
HXLINE(1111)			{
HXLINE(1112)				Float t7 = this->b1->imass;
HXLINE(1121)				 ::zpp_nape::phys::ZPP_Body _hx_tmp6 = this->b1;
HXDLIN(1121)				_hx_tmp6->velx = (_hx_tmp6->velx - (Jx * t7));
HXLINE(1122)				 ::zpp_nape::phys::ZPP_Body _hx_tmp7 = this->b1;
HXDLIN(1122)				_hx_tmp7->vely = (_hx_tmp7->vely - (Jy * t7));
            			}
HXLINE(1124)			{
HXLINE(1125)				Float t8 = this->b2->imass;
HXLINE(1134)				 ::zpp_nape::phys::ZPP_Body _hx_tmp8 = this->b2;
HXDLIN(1134)				_hx_tmp8->velx = (_hx_tmp8->velx + (Jx * t8));
HXLINE(1135)				 ::zpp_nape::phys::ZPP_Body _hx_tmp9 = this->b2;
HXDLIN(1135)				_hx_tmp9->vely = (_hx_tmp9->vely + (Jy * t8));
            			}
...
HXLINE(1200)		{
HXLINE(1201)			Float t = ((Float)0.5);
HXLINE(1202)			{
HXLINE(1203)				Float t1 = t;
HXLINE(1212)				Ex = (Ex * t1);
HXLINE(1213)				Ey = (Ey * t1);
            			}
HXLINE(1215)			Ez = (Ez * t);
            		}
...
HXLINE(1241)				{
HXLINE(1242)					int t2 = 20;
HXLINE(1251)					Float ls = ((Jx * Jx) + (Jy * Jy));
HXLINE(1252)					if ((ls > (t2 * t2))) {
HXLINE(1262)						Float t3 = (( (Float)(t2) ) * (((Float)1.0) / ::Math_obj::sqrt(ls)));
HXLINE(1271)						Jx = (Jx * t3);
HXLINE(1272)						Jy = (Jy * t3);
            					}
            				}
HXLINE(1276)				{
HXLINE(1277)					Float t4 = this->b1->imass;
HXLINE(1286)					 ::zpp_nape::phys::ZPP_Body _hx_tmp1 = this->b1;
HXDLIN(1286)					_hx_tmp1->posx = (_hx_tmp1->posx - (Jx * t4));
HXLINE(1287)					 ::zpp_nape::phys::ZPP_Body _hx_tmp2 = this->b1;
HXDLIN(1287)					_hx_tmp2->posy = (_hx_tmp2->posy - (Jy * t4));
            				}
HXLINE(1289)				{
HXLINE(1290)					Float t5 = this->b2->imass;
HXLINE(1299)					 ::zpp_nape::phys::ZPP_Body _hx_tmp3 = this->b2;
HXDLIN(1299)					_hx_tmp3->posx = (_hx_tmp3->posx + (Jx * t5));
HXLINE(1300)					 ::zpp_nape::phys::ZPP_Body _hx_tmp4 = this->b2;
HXDLIN(1300)					_hx_tmp4->posy = (_hx_tmp4->posy + (Jy * t5));
            				}
HXLINE(1302)				{
...
HXLINE(1307)				{
HXLINE(1308)					Float t6 = ((Float)0.5);
HXLINE(1309)					{
HXLINE(1310)						Float t7 = t6;
HXLINE(1319)						Ex = (Ex * t7);
HXLINE(1320)						Ey = (Ey * t7);
            					}
HXLINE(1322)					Ez = (Ez * t6);
            				}
            			}
            		}
...
HXLINE(1345)				{
HXLINE(1346)					Ka = (Ka + (Y * r1y));
HXLINE(1347)					Kb = (Kb + (-(Y) * r1x));
HXLINE(1348)					Kd = (Kd + (X * r1x));
HXLINE(1349)					Kc = (Kc + -(Y));
HXLINE(1350)					Ke = (Ke + X);
...
HXLINE(1390)		{
HXLINE(1391)			int t8 = 6;
HXLINE(1400)			Float ls1 = ((Jx * Jx) + (Jy * Jy));
HXLINE(1401)			if ((ls1 > (t8 * t8))) {
HXLINE(1411)				Float t9 = (( (Float)(t8) ) * (((Float)1.0) / ::Math_obj::sqrt(ls1)));
HXLINE(1420)				Jx = (Jx * t9);
HXLINE(1421)				Jy = (Jy * t9);
            			}
            		}
HXLINE(1425)		{
HXLINE(1425)			Float a = ((Float)-0.25);
HXDLIN(1425)			if (!((Jz < a))) {
HXLINE(1425)				bool _hx_tmp5 = (Jz > ((Float)0.25));
            			}
            		}
HXLINE(1426)		{
...
HXLINE(1468)		{
HXLINE(1469)			{
HXLINE(1470)				Float t10 = this->b1->imass;
HXLINE(1479)				 ::zpp_nape::phys::ZPP_Body _hx_tmp6 = this->b1;
HXDLIN(1479)				_hx_tmp6->posx = (_hx_tmp6->posx - (Jx * t10));
HXLINE(1480)				 ::zpp_nape::phys::ZPP_Body _hx_tmp7 = this->b1;
HXDLIN(1480)				_hx_tmp7->posy = (_hx_tmp7->posy - (Jy * t10));
            			}
HXLINE(1482)			{
HXLINE(1483)				Float t11 = this->b2->imass;
HXLINE(1492)				 ::zpp_nape::phys::ZPP_Body _hx_tmp8 = this->b2;
HXDLIN(1492)				_hx_tmp8->posx = (_hx_tmp8->posx + (Jx * t11));
HXLINE(1493)				 ::zpp_nape::phys::ZPP_Body _hx_tmp9 = this->b2;
HXDLIN(1493)				_hx_tmp9->posy = (_hx_tmp9->posy + (Jy * t11));
            			}
HXLINE(1495)			{
HXLINE(1495)				 ::zpp_nape::phys::ZPP_Body _this = this->b1;
HXDLIN(1495)				Float dr = (-((((Jy * r1x) - (Jx * r1y)) + Jz)) * this->b1->iinertia);
HXDLIN(1495)				 ::zpp_nape::phys::ZPP_Body _this1 = _this;
HXDLIN(1495)				_this1->rot = (_this1->rot + dr);
...
HXLINE(1496)			{
HXLINE(1496)				 ::zpp_nape::phys::ZPP_Body _this2 = this->b2;
HXDLIN(1496)				Float dr1 = ((((Jy * r2x) - (Jx * r2y)) + Jz) * this->b2->iinertia);
HXDLIN(1496)				 ::zpp_nape::phys::ZPP_Body _this3 = _this2;
HXDLIN(1496)				_this3->rot = (_this3->rot + dr1);
HXDLIN(1496)				if (((dr1 * dr1) > ((Float)0.0001))) {
HXLINE(1496)					_this2->axisx = ::Math_obj::sin(_this2->rot);
HXDLIN(1496)					_this2->axisy = ::Math_obj::cos(_this2->rot);
            				}
            				else {
HXLINE(1496)					Float d21 = (dr1 * dr1);
HXDLIN(1496)					Float p1 = (( (Float)(1) ) - (((Float)0.5) * d21));
HXDLIN(1496)					Float m2 = (( (Float)(1) ) - ((d21 * d21) / ( (Float)(8) )));
HXDLIN(1496)					Float nx1 = (((p1 * _this2->axisx) + (dr1 * _this2->axisy)) * m2);
HXDLIN(1496)					_this2->axisy = (((p1 * _this2->axisy) - (dr1 * _this2->axisx)) * m2);
HXDLIN(1496)					_this2->axisx = nx1;
            				}
            			}
            		}
