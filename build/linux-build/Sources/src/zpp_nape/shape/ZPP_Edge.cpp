...
HXDLIN( 266)						 ::zpp_nape::geom::ZPP_Vec2 v1 = _this->gverts->next;
HXDLIN( 266)						{
HXLINE( 266)							 ::zpp_nape::shape::ZPP_Edge e1 = ite->elt;
HXDLIN( 266)							ite = ite->next;
HXDLIN( 266)							e1->gp0 = u;
HXDLIN( 266)							e1->gp1 = v1;
HXDLIN( 266)							{
...
HXDLIN( 289)			if (hx::IsEq( ret,::zpp_nape::util::ZPP_PubPool_obj::nextVec2 )) {
...
HXDLIN( 294)			if (hx::IsEq( ret,::zpp_nape::util::ZPP_PubPool_obj::nextVec2 )) {
