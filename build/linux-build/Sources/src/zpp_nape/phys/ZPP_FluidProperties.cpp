...
HXDLIN( 350)			if (hx::IsEq( ret,::zpp_nape::util::ZPP_PubPool_obj::nextVec2 )) {
...
HXLINE( 359)			 ::zpp_nape::shape::ZPP_Shape shape = cx_ite->elt;
HXLINE( 360)			shape->invalidate_fluidprops();
