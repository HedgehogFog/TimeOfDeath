...
HXLINE( 201)				 ::zpp_nape::callbacks::ZPP_CbType cb = cx_ite->elt;
HXLINE( 202)				cb->interactors->add(hx::ObjectPtr<OBJ_>(this));
...
HXLINE( 209)			int flag = -1;
HXDLIN( 209)			this->group->interactors->remove(hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE( 210)		{
HXLINE( 211)			 ::zpp_nape::util::ZNPNode_ZPP_CbType cx_ite = this->cbTypes->head;
HXLINE( 212)			while(hx::IsNotNull( cx_ite )){
HXLINE( 213)				 ::zpp_nape::callbacks::ZPP_CbType cb = cx_ite->elt;
HXLINE( 214)				cb->interactors->remove(hx::ObjectPtr<OBJ_>(this));
...
HXLINE( 333)						 ::zpp_nape::callbacks::ZPP_CbType j = cx_ite->elt;
HXLINE( 334)						{
HXLINE( 335)							if ((cb->id < j->id)) {
...
HXLINE( 391)							 ::zpp_nape::callbacks::ZPP_CbType cb = o->cbTypes->pop_unsafe();
HXDLIN( 391)							cb->cbsets->remove(o);
            						}
            					}
...
HXDLIN( 403)		if (hx::IsNotEq( this->group,group )) {
...
HXLINE( 405)				int flag = -1;
HXDLIN( 405)				this->group->interactors->remove(hx::ObjectPtr<OBJ_>(this));
            			}
...
HXDLIN( 451)				int length = _this2->zpp_inner->user_length;
HXDLIN( 451)				_g->zpp_critical = true;
HXDLIN( 451)				bool _hx_tmp;
HXDLIN( 451)				if ((_g->zpp_i < length)) {
