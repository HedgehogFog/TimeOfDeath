...
HXLINE( 313)		 ::zpp_nape::phys::ZPP_Compound me = hx::ObjectPtr<OBJ_>(this);
...
HXDLIN( 238)		if (hx::IsNotEq( x->zpp_inner->compound,hx::ObjectPtr<OBJ_>(this) )) {
...
HXDLIN( 260)		if (hx::IsNotEq( x->zpp_inner->compound,hx::ObjectPtr<OBJ_>(this) )) {
...
HXLINE( 283)				_hx_tmp = hx::IsNotEq( cur,x->zpp_inner );
            			}
            			else {
...
HXDLIN( 283)			cur = cur->compound;
            		...
            		_hx_goto_14:;
HXLINE( 284)		if (hx::IsEq( cur,x->zpp_inner )) {
...
HXLINE( 344)				 ::zpp_nape::phys::ZPP_Compound c = cx_ite->elt;
HXLINE( 345)				{
HXLINE( 346)					 ::nape::phys::Compound cc = c->copy(dict,todo);
HXLINE( 347)					{
HXLINE( 347)						{
...
HXDLIN( 347)						bool _hx_tmp3 = hx::IsNull( cc->zpp_inner->compound );
            					}
            				}
...
HXDLIN( 359)						if (hx::IsNotEq( _hx_tmp4,ret )) {
...
HXDLIN( 359)							if (hx::IsNotNull( _hx_tmp5 )) {
HXLINE( 359)								 ::nape::phys::Compound _hx_tmp6;
HXDLIN( 359)								if (hx::IsNull( bc->zpp_inner->compound )) {
HXLINE( 359)									_hx_tmp6 = null();
            								}
            								else {
HXLINE( 359)									_hx_tmp6 = bc->zpp_inner->compound->outer;
            								}
HXDLIN( 359)								_hx_tmp6->zpp_inner->wrap_bodies->remove(bc);
            							}
...
HXDLIN( 359)						bool _hx_tmp7 = hx::IsNull( bc->zpp_inner->compound );
            					}
            				}
...
HXLINE( 367)				 ::zpp_nape::constraint::ZPP_Constraint c1 = cx_ite2->elt;
HXLINE( 368)				{
HXLINE( 369)					 ::nape::constraint::Constraint cc1 = c1->copy(dict,todo);
HXLINE( 370)					{
...
HXDLIN( 370)						if (hx::IsNotEq( _hx_tmp8,ret )) {
HXLINE( 370)							 ::nape::phys::Compound _hx_tmp9;
HXDLIN( 370)							if (hx::IsNull( cc1->zpp_inner->compound )) {
HXLINE( 370)								_hx_tmp9 = null();
            							}
            							else {
HXLINE( 370)								_hx_tmp9 = cc1->zpp_inner->compound->outer;
            							}
HXDLIN( 370)							if (hx::IsNotNull( _hx_tmp9 )) {
HXLINE( 370)								 ::nape::phys::Compound _hx_tmp10;
HXDLIN( 370)								if (hx::IsNull( cc1->zpp_inner->compound )) {
HXLINE( 370)									_hx_tmp10 = null();
            								}
            								else {
HXLINE( 370)									_hx_tmp10 = cc1->zpp_inner->compound->outer;
            								}
HXDLIN( 370)								_hx_tmp10->zpp_inner->wrap_constraints->remove(cc1);
            							}
...
HXDLIN( 370)						bool _hx_tmp11 = hx::IsNull( cc1->zpp_inner->compound );
            					}
            				}
