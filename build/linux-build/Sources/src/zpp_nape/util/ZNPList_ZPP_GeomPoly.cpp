...
HXLINE(14008)			 ::zpp_nape::geom::ZPP_GeomPoly i = cx_ite->elt;
HXLINE(14009)			this->add(i);
...
HXDLIN(14063)		{
HXDLIN(14063)			 ::zpp_nape::util::ZNPNode_ZPP_GeomPoly o = ret;
HXDLIN(14063)			o->elt = null();
HXDLIN(14063)			o->next = ::zpp_nape::util::ZNPNode_ZPP_GeomPoly_obj::zpp_pool;
HXDLIN(14063)			::zpp_nape::util::ZNPNode_ZPP_GeomPoly_obj::zpp_pool = o;
            		}
...
HXLINE(14079)		{
HXLINE(14080)			 ::zpp_nape::util::ZNPNode_ZPP_GeomPoly o = ret;
HXLINE(14089)			o->elt = null();
HXLINE(14090)			o->next = ::zpp_nape::util::ZNPNode_ZPP_GeomPoly_obj::zpp_pool;
HXLINE(14091)			::zpp_nape::util::ZNPNode_ZPP_GeomPoly_obj::zpp_pool = o;
            		}
...
HXDLIN(14127)		bool ret = false;
HXDLIN(14127)		while(hx::IsNotNull( cur )){
HXDLIN(14127)			if (hx::IsEq( cur->elt,obj )) {
HXDLIN(14127)				{
HXDLIN(14127)					 ::zpp_nape::util::ZNPNode_ZPP_GeomPoly old;
HXDLIN(14127)					 ::zpp_nape::util::ZNPNode_ZPP_GeomPoly ret1;
HXDLIN(14127)					if (hx::IsNull( pre )) {
HXDLIN(14127)						old = this->head;
HXDLIN(14127)						ret1 = old->next;
HXDLIN(14127)						this->head = ret1;
...
HXDLIN(14127)						ret1 = old->next;
HXDLIN(14127)						pre->next = ret1;
HXDLIN(14127)						if (hx::IsNull( ret1 )) {
HXDLIN(14127)							this->pushmod = true;
            						}
            					}
HXDLIN(14127)					{
...
HXDLIN(14163)		bool ret = false;
HXDLIN(14163)		while(hx::IsNotNull( cur )){
HXDLIN(14163)			if (hx::IsEq( cur->elt,obj )) {
HXDLIN(14163)				{
HXDLIN(14163)					 ::zpp_nape::util::ZNPNode_ZPP_GeomPoly old;
HXDLIN(14163)					 ::zpp_nape::util::ZNPNode_ZPP_GeomPoly ret1;
HXDLIN(14163)					if (hx::IsNull( pre )) {
HXDLIN(14163)						old = this->head;
HXDLIN(14163)						ret1 = old->next;
HXDLIN(14163)						this->head = ret1;
...
HXDLIN(14163)						ret1 = old->next;
HXDLIN(14163)						pre->next = ret1;
HXDLIN(14163)						if (hx::IsNull( ret1 )) {
HXDLIN(14163)							this->pushmod = true;
            						}
            					}
HXDLIN(14163)					{
...
HXDLIN(14246)			{
HXDLIN(14246)				 ::zpp_nape::util::ZNPNode_ZPP_GeomPoly o = ret;
HXDLIN(14246)				o->elt = null();
HXDLIN(14246)				o->next = ::zpp_nape::util::ZNPNode_ZPP_GeomPoly_obj::zpp_pool;
HXDLIN(14246)				::zpp_nape::util::ZNPNode_ZPP_GeomPoly_obj::zpp_pool = o;
            			}
...
HXDLIN(14252)			{
HXLINE(14252)				 ::zpp_nape::util::ZNPNode_ZPP_GeomPoly o = ret;
HXDLIN(14252)				o->elt = null();
HXDLIN(14252)				o->next = ::zpp_nape::util::ZNPNode_ZPP_GeomPoly_obj::zpp_pool;
HXDLIN(14252)				::zpp_nape::util::ZNPNode_ZPP_GeomPoly_obj::zpp_pool = o;
            			}
...
HXDLIN(14280)					 ::zpp_nape::geom::ZPP_GeomPoly npite = cx_ite->elt;
HXDLIN(14280)					if (hx::IsEq( npite,obj )) {
...
HXLINE(14299)					 ::zpp_nape::geom::ZPP_GeomPoly npite = cx_ite->elt;
HXLINE(14301)					if (hx::IsEq( npite,obj )) {
