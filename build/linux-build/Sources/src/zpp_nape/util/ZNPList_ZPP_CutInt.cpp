...
HXLINE(5668)			 ::zpp_nape::geom::ZPP_CutInt i = cx_ite->elt;
HXLINE(5669)			this->add(i);
...
HXDLIN(5723)		{
HXDLIN(5723)			 ::zpp_nape::util::ZNPNode_ZPP_CutInt o = ret;
HXDLIN(5723)			o->elt = null();
HXDLIN(5723)			o->next = ::zpp_nape::util::ZNPNode_ZPP_CutInt_obj::zpp_pool;
HXDLIN(5723)			::zpp_nape::util::ZNPNode_ZPP_CutInt_obj::zpp_pool = o;
            		}
...
HXLINE(5739)		{
HXLINE(5740)			 ::zpp_nape::util::ZNPNode_ZPP_CutInt o = ret;
HXLINE(5749)			o->elt = null();
HXLINE(5750)			o->next = ::zpp_nape::util::ZNPNode_ZPP_CutInt_obj::zpp_pool;
HXLINE(5751)			::zpp_nape::util::ZNPNode_ZPP_CutInt_obj::zpp_pool = o;
            		}
...
HXDLIN(5787)		bool ret = false;
HXDLIN(5787)		while(hx::IsNotNull( cur )){
HXDLIN(5787)			if (hx::IsEq( cur->elt,obj )) {
HXDLIN(5787)				{
HXDLIN(5787)					 ::zpp_nape::util::ZNPNode_ZPP_CutInt old;
HXDLIN(5787)					 ::zpp_nape::util::ZNPNode_ZPP_CutInt ret1;
HXDLIN(5787)					if (hx::IsNull( pre )) {
HXDLIN(5787)						old = this->head;
HXDLIN(5787)						ret1 = old->next;
HXDLIN(5787)						this->head = ret1;
...
HXDLIN(5787)						ret1 = old->next;
HXDLIN(5787)						pre->next = ret1;
HXDLIN(5787)						if (hx::IsNull( ret1 )) {
HXDLIN(5787)							this->pushmod = true;
            						}
            					}
HXDLIN(5787)					{
...
HXDLIN(5823)		bool ret = false;
HXDLIN(5823)		while(hx::IsNotNull( cur )){
HXDLIN(5823)			if (hx::IsEq( cur->elt,obj )) {
HXDLIN(5823)				{
HXDLIN(5823)					 ::zpp_nape::util::ZNPNode_ZPP_CutInt old;
HXDLIN(5823)					 ::zpp_nape::util::ZNPNode_ZPP_CutInt ret1;
HXDLIN(5823)					if (hx::IsNull( pre )) {
HXDLIN(5823)						old = this->head;
HXDLIN(5823)						ret1 = old->next;
HXDLIN(5823)						this->head = ret1;
...
HXDLIN(5823)						ret1 = old->next;
HXDLIN(5823)						pre->next = ret1;
HXDLIN(5823)						if (hx::IsNull( ret1 )) {
HXDLIN(5823)							this->pushmod = true;
            						}
            					}
HXDLIN(5823)					{
...
HXDLIN(5906)			{
HXDLIN(5906)				 ::zpp_nape::util::ZNPNode_ZPP_CutInt o = ret;
HXDLIN(5906)				o->elt = null();
HXDLIN(5906)				o->next = ::zpp_nape::util::ZNPNode_ZPP_CutInt_obj::zpp_pool;
HXDLIN(5906)				::zpp_nape::util::ZNPNode_ZPP_CutInt_obj::zpp_pool = o;
            			}
...
HXDLIN(5912)			{
HXLINE(5912)				 ::zpp_nape::util::ZNPNode_ZPP_CutInt o = ret;
HXDLIN(5912)				o->elt = null();
HXDLIN(5912)				o->next = ::zpp_nape::util::ZNPNode_ZPP_CutInt_obj::zpp_pool;
HXDLIN(5912)				::zpp_nape::util::ZNPNode_ZPP_CutInt_obj::zpp_pool = o;
            			}
...
HXDLIN(5940)					 ::zpp_nape::geom::ZPP_CutInt npite = cx_ite->elt;
HXDLIN(5940)					if (hx::IsEq( npite,obj )) {
...
HXLINE(5959)					 ::zpp_nape::geom::ZPP_CutInt npite = cx_ite->elt;
HXLINE(5961)					if (hx::IsEq( npite,obj )) {
