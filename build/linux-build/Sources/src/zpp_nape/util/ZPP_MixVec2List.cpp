...
HXLINE(16303)					 ::zpp_nape::geom::ZPP_Vec2 i = cx_ite;
...
HXLINE(16331)				 ::zpp_nape::geom::ZPP_Vec2 x = this->at_ite;
...
HXLINE(16340)				 ::zpp_nape::geom::ZPP_Vec2 x1 = this->at_ite;
...
HXDLIN(16404)			 ::nape::geom::Vec2 retx = ret->outer;
HXLINE(16405)			if (hx::IsNotNull( this->zpp_inner->subber )) {
HXLINE(16405)				this->zpp_inner->subber(retx);
            			}
...
HXDLIN(16412)			 ::nape::geom::Vec2 retx1 = ret->outer;
HXLINE(16413)			if (hx::IsNotNull( this->zpp_inner->subber )) {
HXLINE(16413)				this->zpp_inner->subber(retx1);
            			}
...
HXDLIN(16417)		 ::nape::geom::Vec2 retx2 = ret->outer;
HXLINE(16418)		return retx2;
            	}
...
HXDLIN(16435)			 ::nape::geom::Vec2 retx = ret->outer;
HXLINE(16436)			if (hx::IsNotNull( this->zpp_inner->subber )) {
HXLINE(16436)				this->zpp_inner->subber(retx);
            			}
...
HXDLIN(16441)			 ::nape::geom::Vec2 retx1 = ret->outer;
HXLINE(16442)			if (hx::IsNotNull( this->zpp_inner->subber )) {
HXLINE(16442)				this->zpp_inner->subber(retx1);
            			}
...
HXDLIN(16446)		 ::nape::geom::Vec2 retx2 = ret->outer;
HXLINE(16447)		return retx2;
            	}
...
HXLINE(16462)					 ::zpp_nape::geom::ZPP_Vec2 x = cx_ite;
HXLINE(16464)					if (hx::IsEq( obj->zpp_inner,x )) {
