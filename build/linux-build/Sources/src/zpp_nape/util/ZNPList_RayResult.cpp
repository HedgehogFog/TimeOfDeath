...
HXLINE(14425)			 ::nape::geom::RayResult i = cx_ite->elt;
HXLINE(14426)			this->add(i);
...
HXDLIN(14480)		{
HXDLIN(14480)			 ::zpp_nape::util::ZNPNode_RayResult o = ret;
HXDLIN(14480)			o->elt = null();
HXDLIN(14480)			o->next = ::zpp_nape::util::ZNPNode_RayResult_obj::zpp_pool;
HXDLIN(14480)			::zpp_nape::util::ZNPNode_RayResult_obj::zpp_pool = o;
            		}
...
HXLINE(14496)		{
HXLINE(14497)			 ::zpp_nape::util::ZNPNode_RayResult o = ret;
HXLINE(14506)			o->elt = null();
HXLINE(14507)			o->next = ::zpp_nape::util::ZNPNode_RayResult_obj::zpp_pool;
HXLINE(14508)			::zpp_nape::util::ZNPNode_RayResult_obj::zpp_pool = o;
            		}
...
HXDLIN(14544)		bool ret = false;
HXDLIN(14544)		while(hx::IsNotNull( cur )){
HXDLIN(14544)			if (hx::IsEq( cur->elt,obj )) {
HXDLIN(14544)				{
HXDLIN(14544)					 ::zpp_nape::util::ZNPNode_RayResult old;
HXDLIN(14544)					 ::zpp_nape::util::ZNPNode_RayResult ret1;
HXDLIN(14544)					if (hx::IsNull( pre )) {
HXDLIN(14544)						old = this->head;
HXDLIN(14544)						ret1 = old->next;
HXDLIN(14544)						this->head = ret1;
...
HXDLIN(14544)						ret1 = old->next;
HXDLIN(14544)						pre->next = ret1;
HXDLIN(14544)						if (hx::IsNull( ret1 )) {
HXDLIN(14544)							this->pushmod = true;
            						}
            					}
HXDLIN(14544)					{
...
HXDLIN(14580)		bool ret = false;
HXDLIN(14580)		while(hx::IsNotNull( cur )){
HXDLIN(14580)			if (hx::IsEq( cur->elt,obj )) {
HXDLIN(14580)				{
HXDLIN(14580)					 ::zpp_nape::util::ZNPNode_RayResult old;
HXDLIN(14580)					 ::zpp_nape::util::ZNPNode_RayResult ret1;
HXDLIN(14580)					if (hx::IsNull( pre )) {
HXDLIN(14580)						old = this->head;
HXDLIN(14580)						ret1 = old->next;
HXDLIN(14580)						this->head = ret1;
...
HXDLIN(14580)						ret1 = old->next;
HXDLIN(14580)						pre->next = ret1;
HXDLIN(14580)						if (hx::IsNull( ret1 )) {
HXDLIN(14580)							this->pushmod = true;
            						}
            					}
HXDLIN(14580)					{
...
HXDLIN(14663)			{
HXDLIN(14663)				 ::zpp_nape::util::ZNPNode_RayResult o = ret;
HXDLIN(14663)				o->elt = null();
HXDLIN(14663)				o->next = ::zpp_nape::util::ZNPNode_RayResult_obj::zpp_pool;
HXDLIN(14663)				::zpp_nape::util::ZNPNode_RayResult_obj::zpp_pool = o;
            			}
...
HXDLIN(14669)			{
HXLINE(14669)				 ::zpp_nape::util::ZNPNode_RayResult o = ret;
HXDLIN(14669)				o->elt = null();
HXDLIN(14669)				o->next = ::zpp_nape::util::ZNPNode_RayResult_obj::zpp_pool;
HXDLIN(14669)				::zpp_nape::util::ZNPNode_RayResult_obj::zpp_pool = o;
            			}
...
HXDLIN(14697)					 ::nape::geom::RayResult npite = cx_ite->elt;
HXDLIN(14697)					if (hx::IsEq( npite,obj )) {
...
HXLINE(14716)					 ::nape::geom::RayResult npite = cx_ite->elt;
HXLINE(14718)					if (hx::IsEq( npite,obj )) {
