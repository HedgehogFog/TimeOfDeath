...
HXLINE(13591)			 ::nape::geom::ConvexResult i = cx_ite->elt;
HXLINE(13592)			this->add(i);
...
HXDLIN(13646)		{
HXDLIN(13646)			 ::zpp_nape::util::ZNPNode_ConvexResult o = ret;
HXDLIN(13646)			o->elt = null();
HXDLIN(13646)			o->next = ::zpp_nape::util::ZNPNode_ConvexResult_obj::zpp_pool;
HXDLIN(13646)			::zpp_nape::util::ZNPNode_ConvexResult_obj::zpp_pool = o;
            		}
...
HXLINE(13662)		{
HXLINE(13663)			 ::zpp_nape::util::ZNPNode_ConvexResult o = ret;
HXLINE(13672)			o->elt = null();
HXLINE(13673)			o->next = ::zpp_nape::util::ZNPNode_ConvexResult_obj::zpp_pool;
HXLINE(13674)			::zpp_nape::util::ZNPNode_ConvexResult_obj::zpp_pool = o;
            		}
...
HXDLIN(13710)		bool ret = false;
HXDLIN(13710)		while(hx::IsNotNull( cur )){
HXDLIN(13710)			if (hx::IsEq( cur->elt,obj )) {
HXDLIN(13710)				{
HXDLIN(13710)					 ::zpp_nape::util::ZNPNode_ConvexResult old;
HXDLIN(13710)					 ::zpp_nape::util::ZNPNode_ConvexResult ret1;
HXDLIN(13710)					if (hx::IsNull( pre )) {
HXDLIN(13710)						old = this->head;
HXDLIN(13710)						ret1 = old->next;
HXDLIN(13710)						this->head = ret1;
...
HXDLIN(13710)						ret1 = old->next;
HXDLIN(13710)						pre->next = ret1;
HXDLIN(13710)						if (hx::IsNull( ret1 )) {
HXDLIN(13710)							this->pushmod = true;
            						}
            					}
HXDLIN(13710)					{
...
HXDLIN(13746)		bool ret = false;
HXDLIN(13746)		while(hx::IsNotNull( cur )){
HXDLIN(13746)			if (hx::IsEq( cur->elt,obj )) {
HXDLIN(13746)				{
HXDLIN(13746)					 ::zpp_nape::util::ZNPNode_ConvexResult old;
HXDLIN(13746)					 ::zpp_nape::util::ZNPNode_ConvexResult ret1;
HXDLIN(13746)					if (hx::IsNull( pre )) {
HXDLIN(13746)						old = this->head;
HXDLIN(13746)						ret1 = old->next;
HXDLIN(13746)						this->head = ret1;
...
HXDLIN(13746)						ret1 = old->next;
HXDLIN(13746)						pre->next = ret1;
HXDLIN(13746)						if (hx::IsNull( ret1 )) {
HXDLIN(13746)							this->pushmod = true;
            						}
            					}
HXDLIN(13746)					{
...
HXDLIN(13829)			{
HXDLIN(13829)				 ::zpp_nape::util::ZNPNode_ConvexResult o = ret;
HXDLIN(13829)				o->elt = null();
HXDLIN(13829)				o->next = ::zpp_nape::util::ZNPNode_ConvexResult_obj::zpp_pool;
HXDLIN(13829)				::zpp_nape::util::ZNPNode_ConvexResult_obj::zpp_pool = o;
            			}
...
HXDLIN(13835)			{
HXLINE(13835)				 ::zpp_nape::util::ZNPNode_ConvexResult o = ret;
HXDLIN(13835)				o->elt = null();
HXDLIN(13835)				o->next = ::zpp_nape::util::ZNPNode_ConvexResult_obj::zpp_pool;
HXDLIN(13835)				::zpp_nape::util::ZNPNode_ConvexResult_obj::zpp_pool = o;
            			}
...
HXDLIN(13863)					 ::nape::geom::ConvexResult npite = cx_ite->elt;
HXDLIN(13863)					if (hx::IsEq( npite,obj )) {
...
HXLINE(13882)					 ::nape::geom::ConvexResult npite = cx_ite->elt;
HXLINE(13884)					if (hx::IsEq( npite,obj )) {
