...
HX_LOCAL_STACK_FRAME(_hx_pos_03b953c698427010_2185_remove,"zpp_nape.util.ZPP_Set_ZPP_PartitionVertex","remove",0x8d8aa4d6,"zpp_nape.util.ZPP_Set_ZPP_PartitionVertex.remove","zpp_nape/util/RBTree.hx",2185,0x3f078845)
...
HXLINE(2082)				 ::zpp_nape::geom::ZPP_PartitionVertex i = set_ite->data;
...
void ZPP_Set_ZPP_PartitionVertex_obj::remove( ::zpp_nape::geom::ZPP_PartitionVertex obj){
            	HX_STACKFRAME(&_hx_pos_03b953c698427010_2185_remove)
HXLINE(2186)		 ::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex node = this->find(obj);
HXLINE(2195)		this->remove_node(node);
            	}
...
HXDLIN(2388)							if (hx::IsEq( cur,ret->prev )) {
...
HXLINE(2416)		{
HXLINE(2417)			 ::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex o = node;
HXLINE(2426)			{
HXLINE(2426)				o->data = null();
HXDLIN(2426)				o->lt = null();
HXDLIN(2426)				o->swapped = null();
            			}
HXLINE(2427)			o->next = ::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex_obj::zpp_pool;
HXLINE(2428)			::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex_obj::zpp_pool = o;
            		}
