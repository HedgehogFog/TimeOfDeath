...
HX_LOCAL_STACK_FRAME(_hx_pos_ee82dba092594d88_407_remove,"zpp_nape.util.ZPP_Set_ZPP_Body","remove",0x1f633e3e,"zpp_nape.util.ZPP_Set_ZPP_Body.remove","zpp_nape/util/RBTree.hx",407,0x3f078845)
...
HXLINE( 304)				 ::zpp_nape::phys::ZPP_Body i = set_ite->data;
...
void ZPP_Set_ZPP_Body_obj::remove( ::zpp_nape::phys::ZPP_Body obj){
            	HX_STACKFRAME(&_hx_pos_ee82dba092594d88_407_remove)
HXLINE( 408)		 ::zpp_nape::util::ZPP_Set_ZPP_Body node = this->find(obj);
HXLINE( 417)		this->remove_node(node);
            	}
...
HXDLIN( 610)							if (hx::IsEq( cur,ret->prev )) {
...
HXLINE( 638)		{
HXLINE( 639)			 ::zpp_nape::util::ZPP_Set_ZPP_Body o = node;
HXLINE( 648)			{
HXLINE( 648)				o->data = null();
HXDLIN( 648)				o->lt = null();
HXDLIN( 648)				o->swapped = null();
            			}
HXLINE( 649)			o->next = ::zpp_nape::util::ZPP_Set_ZPP_Body_obj::zpp_pool;
HXLINE( 650)			::zpp_nape::util::ZPP_Set_ZPP_Body_obj::zpp_pool = o;
            		}
