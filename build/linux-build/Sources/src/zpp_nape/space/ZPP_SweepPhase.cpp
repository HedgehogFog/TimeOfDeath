...
HXLINE( 276)		{
HXLINE( 277)			 ::zpp_nape::space::ZPP_SweepData o = dat;
HXLINE( 286)			{
HXLINE( 286)				o->prev = null();
HXDLIN( 286)				o->shape = null();
HXDLIN( 286)				o->aabb = null();
            			}
HXLINE( 287)			o->next = ::zpp_nape::space::ZPP_SweepData_obj::zpp_pool;
HXLINE( 288)			::zpp_nape::space::ZPP_SweepData_obj::zpp_pool = o;
            		}
            	}
...
HXDLIN( 305)												{
HXDLIN( 305)													Float t = ((Float)1.0);
HXDLIN( 305)													 ::zpp_nape::shape::ZPP_Polygon _this2 = _this1;
HXDLIN( 305)													_this2->localCOMx = (_this2->localCOMx + (_this1->lverts->next->next->x * t));
HXDLIN( 305)													 ::zpp_nape::shape::ZPP_Polygon _this3 = _this1;
HXDLIN( 305)													_this3->localCOMy = (_this3->localCOMy + (_this1->lverts->next->next->y * t));
            												}
HXDLIN( 305)												{
HXDLIN( 305)													Float t1 = ((Float)0.5);
HXDLIN( 305)													 ::zpp_nape::shape::ZPP_Polygon _this4 = _this1;
HXDLIN( 305)													_this4->localCOMx = (_this4->localCOMx * t1);
HXDLIN( 305)													 ::zpp_nape::shape::ZPP_Polygon _this5 = _this1;
HXDLIN( 305)													_this5->localCOMy = (_this5->localCOMy * t1);
            												}
            											}
            											else {
HXDLIN( 305)												{
...
HXDLIN( 305)															 ::zpp_nape::shape::ZPP_Polygon _this6 = _this1;
HXDLIN( 305)															_this6->localCOMx = (_this6->localCOMx + ((v->x + w->x) * cf));
HXDLIN( 305)															 ::zpp_nape::shape::ZPP_Polygon _this7 = _this1;
HXDLIN( 305)															_this7->localCOMy = (_this7->localCOMy + ((v->y + w->y) * cf));
            														}
HXDLIN( 305)														u = v;
HXDLIN( 305)														v = w;
HXDLIN( 305)														cx_ite = cx_ite->next;
...
HXDLIN( 305)														 ::zpp_nape::shape::ZPP_Polygon _this8 = _this1;
HXDLIN( 305)														_this8->localCOMx = (_this8->localCOMx + ((v->x + w1->x) * cf1));
HXDLIN( 305)														 ::zpp_nape::shape::ZPP_Polygon _this9 = _this1;
HXDLIN( 305)														_this9->localCOMy = (_this9->localCOMy + ((v->y + w1->y) * cf1));
            													}
HXDLIN( 305)													u = v;
HXDLIN( 305)													v = w1;
HXDLIN( 305)													cx_ite = cx_ite->next;
...
HXDLIN( 305)													{
HXDLIN( 305)														area = (area + (v->x * (w2->y - u->y)));
HXDLIN( 305)														Float cf2 = ((w2->y * v->x) - (w2->x * v->y));
HXDLIN( 305)														 ::zpp_nape::shape::ZPP_Polygon _this10 = _this1;
HXDLIN( 305)														_this10->localCOMx = (_this10->localCOMx + ((v->x + w2->x) * cf2));
HXDLIN( 305)														 ::zpp_nape::shape::ZPP_Polygon _this11 = _this1;
HXDLIN( 305)														_this11->localCOMy = (_this11->localCOMy + ((v->y + w2->y) * cf2));
            													}
            												}
HXDLIN( 305)												area = (( (Float)(1) ) / (( (Float)(3) ) * area));
HXDLIN( 305)												{
HXDLIN( 305)													Float t2 = area;
HXDLIN( 305)													 ::zpp_nape::shape::ZPP_Polygon _this12 = _this1;
HXDLIN( 305)													_this12->localCOMx = (_this12->localCOMx * t2);
HXDLIN( 305)													 ::zpp_nape::shape::ZPP_Polygon _this13 = _this1;
HXDLIN( 305)													_this13->localCOMy = (_this13->localCOMy * t2);
            												}
            											}
            										}
            									}
...
HXDLIN( 305)								{
HXDLIN( 305)									 ::zpp_nape::phys::ZPP_Body _this14 = _this->body;
HXDLIN( 305)									if (_this14->zip_axis) {
HXDLIN( 305)										_this14->zip_axis = false;
HXDLIN( 305)										{
HXDLIN( 305)											_this14->axisx = ::Math_obj::sin(_this14->rot);
HXDLIN( 305)											_this14->axisy = ::Math_obj::cos(_this14->rot);
            										}
            									}
            								}
HXDLIN( 305)								{
...
HXDLIN( 305)						 ::zpp_nape::shape::ZPP_Polygon _this15 = shape->polygon;
HXDLIN( 305)						if (_this15->zip_gverts) {
HXDLIN( 305)							if (hx::IsNotNull( _this15->body )) {
HXDLIN( 305)								_this15->zip_gverts = false;
HXDLIN( 305)								_this15->validate_lverts();
HXDLIN( 305)								{
HXDLIN( 305)									 ::zpp_nape::phys::ZPP_Body _this16 = _this15->body;
HXDLIN( 305)									if (_this16->zip_axis) {
HXDLIN( 305)										_this16->zip_axis = false;
HXDLIN( 305)										{
HXDLIN( 305)											_this16->axisx = ::Math_obj::sin(_this16->rot);
HXDLIN( 305)											_this16->axisy = ::Math_obj::cos(_this16->rot);
            										}
            									}
            								}
HXDLIN( 305)								 ::zpp_nape::geom::ZPP_Vec2 li = _this15->lverts->next;
HXDLIN( 305)								{
HXDLIN( 305)									 ::zpp_nape::geom::ZPP_Vec2 cx_ite1 = _this15->gverts->next;
...
HXDLIN( 305)											{
HXDLIN( 305)												g->x = (_this15->body->posx + ((_this15->body->axisy * l->x) - (_this15->body->axisx * l->y)));
HXDLIN( 305)												g->y = (_this15->body->posy + ((l->x * _this15->body->axisx) + (l->y * _this15->body->axisy)));
            											}
            										}
...
HXDLIN( 305)						if (hx::IsNull( _this15->lverts->next )) {
HXDLIN( 305)							HX_STACK_DO_THROW(HX_("Error: An empty polygon has no meaningful bounds",da,28,5b,f5));
            						}
HXDLIN( 305)						 ::zpp_nape::geom::ZPP_Vec2 p0 = _this15->gverts->next;
HXDLIN( 305)						{
HXDLIN( 305)							_this15->aabb->minx = p0->x;
HXDLIN( 305)							_this15->aabb->miny = p0->y;
            						}
HXDLIN( 305)						{
HXDLIN( 305)							_this15->aabb->maxx = p0->x;
HXDLIN( 305)							_this15->aabb->maxy = p0->y;
            						}
HXDLIN( 305)						{
HXDLIN( 305)							 ::zpp_nape::geom::ZPP_Vec2 cx_ite2 = _this15->gverts->next->next;
HXDLIN( 305)							while(hx::IsNotNull( cx_ite2 )){
HXDLIN( 305)								 ::zpp_nape::geom::ZPP_Vec2 p = cx_ite2;
HXDLIN( 305)								{
HXDLIN( 305)									if ((p->x < _this15->aabb->minx)) {
HXDLIN( 305)										_this15->aabb->minx = p->x;
            									}
HXDLIN( 305)									if ((p->x > _this15->aabb->maxx)) {
HXDLIN( 305)										_this15->aabb->maxx = p->x;
            									}
HXDLIN( 305)									if ((p->y < _this15->aabb->miny)) {
HXDLIN( 305)										_this15->aabb->miny = p->y;
            									}
HXDLIN( 305)									if ((p->y > _this15->aabb->maxy)) {
HXDLIN( 305)										_this15->aabb->maxy = p->y;
            									}
            								}
...
HXLINE( 408)			a = a->next;
            		...
            		_hx_goto_21:;
HXLINE( 410)		{
HXLINE( 411)			 ::zpp_nape::geom::ZPP_Vec2 o = v;
HXLINE( 420)			{
HXLINE( 420)				if (hx::IsNotNull( o->outer )) {
HXLINE( 420)					o->outer->zpp_inner = null();
HXDLIN( 420)					o->outer = null();
            				}
HXDLIN( 420)				o->_isimmutable = null();
HXDLIN( 420)				o->_validate = null();
HXDLIN( 420)				o->_invalidate = null();
            			}
HXLINE( 421)			o->next = ::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool;
HXLINE( 422)			::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool = o;
            		}
...
HXLINE( 450)			a = a->next;
            		...
            		_hx_goto_24:;
HXLINE( 452)		{
HXLINE( 453)			 ::zpp_nape::geom::ZPP_Vec2 o = v;
HXLINE( 462)			{
HXLINE( 462)				if (hx::IsNotNull( o->outer )) {
HXLINE( 462)					o->outer->zpp_inner = null();
HXDLIN( 462)					o->outer = null();
            				}
HXDLIN( 462)				o->_isimmutable = null();
HXDLIN( 462)				o->_validate = null();
HXDLIN( 462)				o->_invalidate = null();
            			}
HXLINE( 463)			o->next = ::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool;
HXLINE( 464)			::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool = o;
            		}
...
HXLINE( 726)		{
HXLINE( 727)			 ::zpp_nape::geom::ZPP_AABB o = rayab;
HXLINE( 736)			{
HXLINE( 736)				if (hx::IsNotNull( o->outer )) {
HXLINE( 736)					o->outer->zpp_inner = null();
HXDLIN( 736)					o->outer = null();
            				}
HXDLIN( 736)				o->wrap_min = (o->wrap_max = null());
HXDLIN( 736)				o->_invalidate = null();
HXDLIN( 736)				o->_validate = null();
            			}
HXLINE( 737)			o->next = ::zpp_nape::geom::ZPP_AABB_obj::zpp_pool;
HXLINE( 738)			::zpp_nape::geom::ZPP_AABB_obj::zpp_pool = o;
            		}
...
HXLINE( 754)					Float t = ray->aabbsect(a->aabb);
HXLINE( 755)					if ((t >= 0)) {
...
HXLINE( 773)						Float t1 = ray->aabbsect(a1->aabb);
HXLINE( 774)						if ((t1 >= 0)) {
...
HXLINE( 786)						Float t2 = ray->aabbsect(a2->aabb);
HXLINE( 787)						if ((t2 >= 0)) {
...
HXLINE( 795)		{
HXLINE( 796)			 ::zpp_nape::geom::ZPP_AABB o = rayab;
HXLINE( 805)			{
HXLINE( 805)				if (hx::IsNotNull( o->outer )) {
HXLINE( 805)					o->outer->zpp_inner = null();
HXDLIN( 805)					o->outer = null();
            				}
HXDLIN( 805)				o->wrap_min = (o->wrap_max = null());
HXDLIN( 805)				o->_invalidate = null();
HXDLIN( 805)				o->_validate = null();
            			}
HXLINE( 806)			o->next = ::zpp_nape::geom::ZPP_AABB_obj::zpp_pool;
HXLINE( 807)			::zpp_nape::geom::ZPP_AABB_obj::zpp_pool = o;
            		}
