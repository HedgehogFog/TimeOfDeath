...
HXLINE(1244)					 ::zpp_nape::callbacks::ZPP_CbType cb = o->cbTypes->pop_unsafe();
HXDLIN(1244)					cb->cbsets->remove(o);
            				}
            			}
...
HXLINE(1263)				{
HXLINE(1264)					 ::zpp_nape::callbacks::ZPP_CbSetPair o = pair;
HXLINE(1273)					{
HXLINE(1273)						o->a = (o->b = null());
HXDLIN(1273)						o->listeners->clear();
            					}
HXLINE(1274)					o->next = ::zpp_nape::callbacks::ZPP_CbSetPair_obj::zpp_pool;
HXLINE(1275)					::zpp_nape::callbacks::ZPP_CbSetPair_obj::zpp_pool = o;
            				}
            			}
            		}
...
HXLINE(1332)				 ::zpp_nape::callbacks::ZPP_CbSet cb = set_ite->data;
HXLINE(1333)				cb->validate();
...
HXDLIN(1375)		return hx::IsEq( i->space,this->space );
            	}
