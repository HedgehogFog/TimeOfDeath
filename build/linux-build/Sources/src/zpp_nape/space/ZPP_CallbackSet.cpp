...
HXDLIN( 727)		 ::zpp_nape::space::ZPP_CallbackSet temp = o;
HXDLIN( 727)		temp->next = this->next;
HXDLIN( 727)		this->next = temp;
...
HXLINE( 740)		 ::zpp_nape::space::ZPP_CallbackSet temp = o;
HXLINE( 744)		temp->next = this->next;
HXLINE( 745)		this->next = temp;
...
HXLINE( 762)			 ::zpp_nape::space::ZPP_CallbackSet i = cx_ite;
HXLINE( 763)			this->add(i);
...
HXDLIN( 769)		 ::zpp_nape::space::ZPP_CallbackSet temp = o;
HXDLIN( 769)		if (hx::IsNull( cur )) {
HXDLIN( 769)			temp->next = this->next;
HXDLIN( 769)			this->next = temp;
            		}
            		else {
HXDLIN( 769)			temp->next = cur->next;
HXDLIN( 769)			cur->next = temp;
            		}
HXDLIN( 769)		this->pushmod = (this->modified = true);
HXDLIN( 769)		this->length++;
HXDLIN( 769)		return temp;
            	}
...
HXLINE( 782)		 ::zpp_nape::space::ZPP_CallbackSet temp = o;
HXLINE( 786)		if (hx::IsNull( cur )) {
HXLINE( 787)			temp->next = this->next;
HXLINE( 788)			this->next = temp;
            		}
            		else {
HXLINE( 791)			temp->next = cur->next;
HXLINE( 792)			cur->next = temp;
            		}
HXLINE( 794)		this->pushmod = (this->modified = true);
HXLINE( 795)		this->length++;
HXLINE( 796)		return temp;
            	}
...
HXDLIN( 849)		bool ret = false;
HXDLIN( 849)		while(hx::IsNotNull( cur )){
HXDLIN( 849)			if (hx::IsEq( cur,obj )) {
HXDLIN( 849)				{
HXDLIN( 849)					 ::zpp_nape::space::ZPP_CallbackSet old;
HXDLIN( 849)					 ::zpp_nape::space::ZPP_CallbackSet ret1;
HXDLIN( 849)					if (hx::IsNull( pre )) {
HXDLIN( 849)						old = this->next;
HXDLIN( 849)						ret1 = old->next;
HXDLIN( 849)						this->next = ret1;
...
HXDLIN( 849)						ret1 = old->next;
HXDLIN( 849)						pre->next = ret1;
HXDLIN( 849)						if (hx::IsNull( ret1 )) {
HXDLIN( 849)							this->pushmod = true;
            						}
            					}
...
HXDLIN( 885)		bool ret = false;
HXDLIN( 885)		while(hx::IsNotNull( cur )){
HXDLIN( 885)			if (hx::IsEq( cur,obj )) {
HXDLIN( 885)				{
HXDLIN( 885)					 ::zpp_nape::space::ZPP_CallbackSet old;
HXDLIN( 885)					 ::zpp_nape::space::ZPP_CallbackSet ret1;
HXDLIN( 885)					if (hx::IsNull( pre )) {
HXDLIN( 885)						old = this->next;
HXDLIN( 885)						ret1 = old->next;
HXDLIN( 885)						this->next = ret1;
...
HXDLIN( 885)						ret1 = old->next;
HXDLIN( 885)						pre->next = ret1;
HXDLIN( 885)						if (hx::IsNull( ret1 )) {
HXDLIN( 885)							this->pushmod = true;
            						}
            					}
...
HXDLIN( 988)					 ::zpp_nape::space::ZPP_CallbackSet npite = cx_ite;
HXDLIN( 988)					if (hx::IsEq( npite,obj )) {
HXDLIN( 988)						ret = true;
...
HXLINE(1007)					 ::zpp_nape::space::ZPP_CallbackSet npite = cx_ite;
HXLINE(1009)					if (hx::IsEq( npite,obj )) {
...
HXDLIN(1118)					 ::zpp_nape::dynamics::ZPP_Arbiter npite = cx_ite->elt;
HXDLIN(1118)					if (hx::IsEq( npite,x )) {
...
HXDLIN(1125)			if (hx::IsEq( cur->elt,x )) {
HXDLIN(1125)				{
...
HXDLIN(1128)			bool ret = false;
HXDLIN(1128)			while(hx::IsNotNull( cur )){
HXDLIN(1128)				if (hx::IsEq( cur->elt,x )) {
HXDLIN(1128)					{
HXDLIN(1128)						 ::zpp_nape::util::ZNPNode_ZPP_Arbiter old;
HXDLIN(1128)						 ::zpp_nape::util::ZNPNode_ZPP_Arbiter ret1;
HXDLIN(1128)						if (hx::IsNull( pre )) {
HXDLIN(1128)							old = _this->head;
HXDLIN(1128)							ret1 = old->next;
HXDLIN(1128)							_this->head = ret1;
...
HXDLIN(1128)							ret1 = old->next;
HXDLIN(1128)							pre->next = ret1;
HXDLIN(1128)							if (hx::IsNull( ret1 )) {
HXDLIN(1128)								_this->pushmod = true;
            							}
            						}
HXDLIN(1128)						{
...
HXLINE(1137)					 ::zpp_nape::dynamics::ZPP_Arbiter x = cx_ite->elt;
HXLINE(1139)					if (((x->type & type) == 0)) {
...
HXLINE(1170)					 ::zpp_nape::dynamics::ZPP_Arbiter x = cx_ite->elt;
HXLINE(1172)					if (x->sleeping) {
