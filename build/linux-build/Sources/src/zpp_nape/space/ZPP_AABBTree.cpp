...
HXLINE( 354)			 ::zpp_nape::space::ZPP_AABBNode node = ret;
HXLINE( 368)			if (hx::IsNull( node->child1 )) {
HXLINE( 369)				node->shape->node = null();
HXLINE( 370)				node->shape->removedFromSpace();
HXLINE( 371)				node->shape = null();
            			}
            			else {
HXLINE( 374)				if (hx::IsNotNull( node->child1 )) {
HXLINE( 383)					node->child1->next = stack;
HXLINE( 384)					stack = node->child1;
            				}
HXLINE( 386)				if (hx::IsNotNull( node->child2 )) {
HXLINE( 395)					node->child2->next = stack;
HXLINE( 396)					stack = node->child2;
            				}
            			}
HXLINE( 399)			{
HXLINE( 400)				 ::zpp_nape::space::ZPP_AABBNode o = node;
HXLINE( 409)				{
HXLINE( 409)					o->height = -1;
HXDLIN( 409)					{
HXLINE( 409)						 ::zpp_nape::geom::ZPP_AABB o1 = o->aabb;
HXDLIN( 409)						{
HXLINE( 409)							if (hx::IsNotNull( o1->outer )) {
HXLINE( 409)								o1->outer->zpp_inner = null();
HXDLIN( 409)								o1->outer = null();
            							}
HXDLIN( 409)							o1->wrap_min = (o1->wrap_max = null());
HXDLIN( 409)							o1->_invalidate = null();
HXDLIN( 409)							o1->_validate = null();
            						}
HXDLIN( 409)						o1->next = ::zpp_nape::geom::ZPP_AABB_obj::zpp_pool;
HXDLIN( 409)						::zpp_nape::geom::ZPP_AABB_obj::zpp_pool = o1;
            					}
HXDLIN( 409)					o->child1 = (o->child2 = (o->parent = null()));
HXDLIN( 409)					o->next = null();
HXDLIN( 409)					o->snext = null();
HXDLIN( 409)					o->mnext = null();
            				}
HXLINE( 410)				o->next = ::zpp_nape::space::ZPP_AABBNode_obj::zpp_pool;
HXLINE( 411)				::zpp_nape::space::ZPP_AABBNode_obj::zpp_pool = o;
            			}
            		}
...
HXDLIN( 421)					Float oarea = (((_this5->maxx - _this5->minx) + (_this5->maxy - _this5->miny)) * ( (Float)(2) ));
HXDLIN( 421)					 ::zpp_nape::geom::ZPP_AABB _this6 = ::zpp_nape::space::ZPP_AABBTree_obj::tmpaabb;
HXDLIN( 421)					Float narea = (((_this6->maxx - _this6->minx) + (_this6->maxy - _this6->miny)) * ( (Float)(2) ));
HXDLIN( 421)					cost1 = ((narea - oarea) + icost);
            				}
HXDLIN( 421)				{
...
HXDLIN( 421)					Float oarea1 = (((_this9->maxx - _this9->minx) + (_this9->maxy - _this9->miny)) * ( (Float)(2) ));
HXDLIN( 421)					 ::zpp_nape::geom::ZPP_AABB _this10 = ::zpp_nape::space::ZPP_AABBTree_obj::tmpaabb;
HXDLIN( 421)					Float narea1 = (((_this10->maxx - _this10->minx) + (_this10->maxy - _this10->miny)) * ( (Float)(2) ));
HXDLIN( 421)					cost2 = ((narea1 - oarea1) + icost);
            				}
...
HXDLIN( 421)				if (hx::IsEq( oparent->child1,sibling )) {
...
HXDLIN( 421)							if (hx::IsEq( c->parent->child1,node )) {
...
HXDLIN( 421)								if (hx::IsEq( b3->parent->child1,node )) {
...
HXDLIN( 445)					Float oarea = (((_this5->maxx - _this5->minx) + (_this5->maxy - _this5->miny)) * ( (Float)(2) ));
HXLINE( 446)					 ::zpp_nape::geom::ZPP_AABB _this6 = ::zpp_nape::space::ZPP_AABBTree_obj::tmpaabb;
HXDLIN( 446)					Float narea = (((_this6->maxx - _this6->minx) + (_this6->maxy - _this6->miny)) * ( (Float)(2) ));
HXLINE( 441)					cost1 = ((narea - oarea) + icost);
            				}
HXLINE( 451)				{
...
HXDLIN( 454)					Float oarea1 = (((_this9->maxx - _this9->minx) + (_this9->maxy - _this9->miny)) * ( (Float)(2) ));
HXLINE( 455)					 ::zpp_nape::geom::ZPP_AABB _this10 = ::zpp_nape::space::ZPP_AABBTree_obj::tmpaabb;
HXDLIN( 455)					Float narea1 = (((_this10->maxx - _this10->minx) + (_this10->maxy - _this10->miny)) * ( (Float)(2) ));
HXLINE( 450)					cost2 = ((narea1 - oarea1) + icost);
            				}
...
HXDLIN( 516)		if (hx::IsEq( leaf,this->root )) {
...
HXDLIN( 516)				if (hx::IsEq( gparent->child1,parent )) {
...
HXDLIN( 516)				{
HXDLIN( 516)					 ::zpp_nape::space::ZPP_AABBNode o = parent;
HXDLIN( 516)					{
HXDLIN( 516)						o->height = -1;
HXDLIN( 516)						{
HXDLIN( 516)							 ::zpp_nape::geom::ZPP_AABB o1 = o->aabb;
HXDLIN( 516)							{
...
HXDLIN( 516)						o->child1 = (o->child2 = (o->parent = null()));
HXDLIN( 516)						o->next = null();
HXDLIN( 516)						o->snext = null();
HXDLIN( 516)						o->mnext = null();
            					}
HXDLIN( 516)					o->next = ::zpp_nape::space::ZPP_AABBNode_obj::zpp_pool;
HXDLIN( 516)					::zpp_nape::space::ZPP_AABBNode_obj::zpp_pool = o;
            				}
...
HXDLIN( 516)								if (hx::IsEq( c->parent->child1,node )) {
...
HXDLIN( 516)									if (hx::IsEq( b->parent->child1,node )) {
...
HXDLIN( 516)				{
HXDLIN( 516)					 ::zpp_nape::space::ZPP_AABBNode o2 = parent;
HXDLIN( 516)					{
HXDLIN( 516)						o2->height = -1;
HXDLIN( 516)						{
HXDLIN( 516)							 ::zpp_nape::geom::ZPP_AABB o3 = o2->aabb;
HXDLIN( 516)							{
HXDLIN( 516)								if (hx::IsNotNull( o3->outer )) {
HXDLIN( 516)									o3->outer->zpp_inner = null();
HXDLIN( 516)									o3->outer = null();
            								}
HXDLIN( 516)								o3->wrap_min = (o3->wrap_max = null());
HXDLIN( 516)								o3->_invalidate = null();
HXDLIN( 516)								o3->_validate = null();
            							}
HXDLIN( 516)							o3->next = ::zpp_nape::geom::ZPP_AABB_obj::zpp_pool;
HXDLIN( 516)							::zpp_nape::geom::ZPP_AABB_obj::zpp_pool = o3;
            						}
HXDLIN( 516)						o2->child1 = (o2->child2 = (o2->parent = null()));
HXDLIN( 516)						o2->next = null();
HXDLIN( 516)						o2->snext = null();
HXDLIN( 516)						o2->mnext = null();
            					}
HXDLIN( 516)					o2->next = ::zpp_nape::space::ZPP_AABBNode_obj::zpp_pool;
HXDLIN( 516)					::zpp_nape::space::ZPP_AABBNode_obj::zpp_pool = o2;
            				}
            			}
            		}
            	}
...
HXDLIN( 521)		if (hx::IsEq( leaf,this->root )) {
...
HXLINE( 533)				{
HXLINE( 534)					 ::zpp_nape::space::ZPP_AABBNode o = parent;
HXLINE( 543)					{
HXLINE( 543)						o->height = -1;
HXDLIN( 543)						{
HXLINE( 543)							 ::zpp_nape::geom::ZPP_AABB o1 = o->aabb;
HXDLIN( 543)							{
HXLINE( 543)								if (hx::IsNotNull( o1->outer )) {
HXLINE( 543)									o1->outer->zpp_inner = null();
HXDLIN( 543)									o1->outer = null();
            								}
HXDLIN( 543)								o1->wrap_min = (o1->wrap_max = null());
HXDLIN( 543)								o1->_invalidate = null();
HXDLIN( 543)								o1->_validate = null();
            							}
HXDLIN( 543)							o1->next = ::zpp_nape::geom::ZPP_AABB_obj::zpp_pool;
HXDLIN( 543)							::zpp_nape::geom::ZPP_AABB_obj::zpp_pool = o1;
            						}
HXDLIN( 543)						o->child1 = (o->child2 = (o->parent = null()));
HXDLIN( 543)						o->next = null();
HXDLIN( 543)						o->snext = null();
HXDLIN( 543)						o->mnext = null();
            					}
HXLINE( 544)					o->next = ::zpp_nape::space::ZPP_AABBNode_obj::zpp_pool;
HXLINE( 545)					::zpp_nape::space::ZPP_AABBNode_obj::zpp_pool = o;
            				}
...
HXLINE( 567)				{
HXLINE( 568)					 ::zpp_nape::space::ZPP_AABBNode o2 = parent;
HXLINE( 577)					{
HXLINE( 577)						o2->height = -1;
HXDLIN( 577)						{
HXLINE( 577)							 ::zpp_nape::geom::ZPP_AABB o3 = o2->aabb;
HXDLIN( 577)							{
HXLINE( 577)								if (hx::IsNotNull( o3->outer )) {
HXLINE( 577)									o3->outer->zpp_inner = null();
HXDLIN( 577)									o3->outer = null();
            								}
HXDLIN( 577)								o3->wrap_min = (o3->wrap_max = null());
HXDLIN( 577)								o3->_invalidate = null();
HXDLIN( 577)								o3->_validate = null();
            							}
HXDLIN( 577)							o3->next = ::zpp_nape::geom::ZPP_AABB_obj::zpp_pool;
HXDLIN( 577)							::zpp_nape::geom::ZPP_AABB_obj::zpp_pool = o3;
            						}
HXDLIN( 577)						o2->child1 = (o2->child2 = (o2->parent = null()));
HXDLIN( 577)						o2->next = null();
HXDLIN( 577)						o2->snext = null();
HXDLIN( 577)						o2->mnext = null();
            					}
HXLINE( 578)					o2->next = ::zpp_nape::space::ZPP_AABBNode_obj::zpp_pool;
HXLINE( 579)					::zpp_nape::space::ZPP_AABBNode_obj::zpp_pool = o2;
            				}
            			}
            		}
            	}
