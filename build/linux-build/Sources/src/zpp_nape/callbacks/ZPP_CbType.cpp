...
HXLINE( 281)				 ::zpp_nape::callbacks::ZPP_CbSet cb = cx_ite1->elt;
HXDLIN( 281)				cb->zip_bodylisteners = true;
...
HXLINE( 287)				 ::zpp_nape::callbacks::ZPP_CbSet cb = cx_ite->elt;
HXDLIN( 287)				cb->zip_bodylisteners = true;
...
HXLINE( 295)			 ::zpp_nape::callbacks::ZPP_CbSet cb = cx_ite->elt;
HXLINE( 296)			cb->zip_bodylisteners = true;
...
HXLINE( 328)				 ::zpp_nape::callbacks::ZPP_CbSet cb = cx_ite1->elt;
HXDLIN( 328)				cb->zip_conlisteners = true;
...
HXLINE( 334)				 ::zpp_nape::callbacks::ZPP_CbSet cb = cx_ite->elt;
HXDLIN( 334)				cb->zip_conlisteners = true;
...
HXLINE( 342)			 ::zpp_nape::callbacks::ZPP_CbSet cb = cx_ite->elt;
HXLINE( 343)			cb->zip_conlisteners = true;
