...
HXDLIN( 419)										ret1 = old->next;
HXDLIN( 419)										_this->head = ret1;
...
HXDLIN( 419)									 ::zpp_nape::util::ZNPNode_ZPP_Arbiter ret3;
HXDLIN( 419)									if (hx::IsNull( pre1 )) {
HXLINE( 419)										old1 = _this1->head;
HXDLIN( 419)										ret3 = old1->next;
HXDLIN( 419)										_this1->head = ret3;
...
HXDLIN( 419)										ret3 = old1->next;
HXDLIN( 419)										pre1->next = ret3;
HXDLIN( 419)										if (hx::IsNull( ret3 )) {
HXLINE( 419)											_this1->pushmod = true;
            										}
            									}
HXDLIN( 419)									{
...
HXLINE( 420)		{
HXLINE( 421)			 ::zpp_nape::dynamics::ZPP_SensorArbiter o2 = hx::ObjectPtr<OBJ_>(this);
