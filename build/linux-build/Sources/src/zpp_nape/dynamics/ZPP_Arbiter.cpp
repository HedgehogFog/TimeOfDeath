...
HXDLIN( 280)							 ::zpp_nape::util::ZNPNode_ZPP_Arbiter ret1;
HXDLIN( 280)							if (hx::IsNull( pre )) {
HXLINE( 280)								old = _this->head;
HXDLIN( 280)								ret1 = old->next;
HXDLIN( 280)								_this->head = ret1;
...
HXDLIN( 280)								ret1 = old->next;
HXDLIN( 280)								pre->next = ret1;
HXDLIN( 280)								if (hx::IsNull( ret1 )) {
HXLINE( 280)									_this->pushmod = true;
            								}
            							}
HXDLIN( 280)							{
...
HXDLIN( 281)							 ::zpp_nape::util::ZNPNode_ZPP_Arbiter ret3;
HXDLIN( 281)							if (hx::IsNull( pre1 )) {
HXLINE( 281)								old1 = _this1->head;
HXDLIN( 281)								ret3 = old1->next;
HXDLIN( 281)								_this1->head = ret3;
...
HXDLIN( 281)								ret3 = old1->next;
HXDLIN( 281)								pre1->next = ret3;
HXDLIN( 281)								if (hx::IsNull( ret3 )) {
HXLINE( 281)									_this1->pushmod = true;
            								}
            							}
HXDLIN( 281)							{
...
HXDLIN( 343)								 ::zpp_nape::util::ZNPNode_ZPP_Arbiter ret1;
HXDLIN( 343)								if (hx::IsNull( pre )) {
HXLINE( 343)									old = _this->head;
HXDLIN( 343)									ret1 = old->next;
HXDLIN( 343)									_this->head = ret1;
...
HXDLIN( 343)									ret1 = old->next;
HXDLIN( 343)									pre->next = ret1;
HXDLIN( 343)									if (hx::IsNull( ret1 )) {
HXLINE( 343)										_this->pushmod = true;
            									}
            								}
HXDLIN( 343)								{
...
HXDLIN( 344)								 ::zpp_nape::util::ZNPNode_ZPP_Arbiter ret3;
HXDLIN( 344)								if (hx::IsNull( pre1 )) {
HXLINE( 344)									old1 = _this1->head;
HXDLIN( 344)									ret3 = old1->next;
HXDLIN( 344)									_this1->head = ret3;
...
HXDLIN( 344)									ret3 = old1->next;
HXDLIN( 344)									pre1->next = ret3;
HXDLIN( 344)									if (hx::IsNull( ret3 )) {
HXLINE( 344)										_this1->pushmod = true;
            									}
            								}
HXDLIN( 344)								{
