...
HX_LOCAL_STACK_FRAME(_hx_pos_3d0c265eae779593_120_parse,"haxe.xml.Parser","parse",0x937905c3,"haxe.xml.Parser.parse","/home/hedgehog/Program/KodeStudio-Linux/resources/app/kodeExtensions/kha/Kha/Tools/haxe/std/haxe/xml/Parser.hx",120,0x7ec4c11a)
HX_LOCAL_STACK_FRAME(_hx_pos_3d0c265eae779593_127_doParse,"haxe.xml.Parser","doParse",0x2e9a6a38,"haxe.xml.Parser.doParse","/home/hedgehog/Program/KodeStudio-Linux/resources/app/kodeExtensions/kha/Kha/Tools/haxe/std/haxe/xml/Parser.hx",127,0x7ec4c11a)
HX_LOCAL_STACK_FRAME(_hx_pos_3d0c265eae779593_104_boot,"haxe.xml.Parser","boot",0x0af6f0a2,"haxe.xml.Parser.boot","/home/hedgehog/Program/KodeStudio-Linux/resources/app/kodeExtensions/kha/Kha/Tools/haxe/std/haxe/xml/Parser.hx",104,0x7ec4c11a)
namespace haxe{
namespace xml{
...
bool Parser_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Xml Parser_obj::parse(::String str,hx::Null< bool >  __o_strict){
            	...
            	HX_STACKFRAME(&_hx_pos_3d0c265eae779593_120_parse)
HXLINE( 121)		 ::Xml doc = ::Xml_obj::createDocument();
HXLINE( 122)		::haxe::xml::Parser_obj::doParse(str,strict,0,doc);
...
int Parser_obj::doParse(::String str,bool strict,hx::Null< int >  __o_p, ::Xml parent){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_3d0c265eae779593_127_doParse)
HXLINE( 128)		 ::Xml xml = null();
HXLINE( 129)		int state = 1;
HXLINE( 130)		int next = 1;
HXLINE( 131)		::String aname = null();
HXLINE( 132)		int start = 0;
HXLINE( 133)		int nsubs = 0;
HXLINE( 134)		int nbrackets = 0;
HXLINE( 135)		int c = str.cca(p);
HXLINE( 136)		 ::StringBuf buf =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 138)		int escapeNext = 1;
HXLINE( 139)		int attrValQuote = -1;
HXLINE( 144)		while((c != 0)){
...
HXLINE( 195)					switch((int)(c)){
            						case (int)33: {
HXLINE( 198)							if ((str.cca((p + 1)) == 91)) {
HXLINE( 200)								p = (p + 2);
HXLINE( 201)								if ((str.substr(p,6).toUpperCase() != HX_("CDATA[",ce,73,5f,1c))) {
HXLINE( 202)									HX_STACK_DO_THROW( ::haxe::xml::XmlParserException_obj::__alloc( HX_CTX ,HX_("Expected <![CDATA[",1c,11,1f,2d),str,p));
            								}
HXLINE( 203)								p = (p + 5);
HXLINE( 204)								state = 17;
HXLINE( 205)								start = (p + 1);
            							}
            							else {
HXLINE( 207)								bool _hx_tmp;
HXDLIN( 207)								if ((str.cca((p + 1)) != 68)) {
HXLINE( 207)									_hx_tmp = (str.cca((p + 1)) == 100);
            								}
            								else {
HXLINE( 207)									_hx_tmp = true;
            								}
HXDLIN( 207)								if (_hx_tmp) {
HXLINE( 209)									if ((str.substr((p + 2),6).toUpperCase() != HX_("OCTYPE",ce,19,d4,61))) {
HXLINE( 210)										HX_STACK_DO_THROW( ::haxe::xml::XmlParserException_obj::__alloc( HX_CTX ,HX_("Expected <!DOCTYPE",c5,0b,26,b6),str,p));
            									}
HXLINE( 211)									p = (p + 8);
HXLINE( 212)									state = 16;
HXLINE( 213)									start = (p + 1);
            								}
            								else {
HXLINE( 215)									bool _hx_tmp1;
HXDLIN( 215)									if ((str.cca((p + 1)) == 45)) {
HXLINE( 215)										_hx_tmp1 = (str.cca((p + 2)) != 45);
            									}
            									else {
...
HXLINE( 263)						::String tmp = str.substr(start,(p - start));
...
HXLINE( 298)							state = 18;
HXLINE( 299)							escapeNext = 8;
HXLINE( 300)							start = (p + 1);
            						}
            						break;
...
HXLINE( 182)							state = 18;
HXLINE( 183)							escapeNext = 13;
HXLINE( 184)							start = (p + 1);
            						}
            					}
            				}
            				break;
...
HXDLIN( 366)					if ((c == 63)) {
HXLINE( 366)						_hx_tmp23 = (str.cca((p + 1)) == 62);
            					}
            					else {
...
HXLINE( 368)						p = (p + 1);
HXLINE( 369)						::String str1 = str.substr((start + 1),((p - start) - 2));
HXLINE( 370)						{
HXLINE( 370)							parent->addChild(::Xml_obj::createProcessingInstruction(str1));
HXDLIN( 370)							nsubs = (nsubs + 1);
            						}
HXLINE( 371)						state = 1;
            					}
            				}
...
HXDLIN( 349)					if ((c == 45)) {
HXLINE( 349)						_hx_tmp25 = (str.cca((p + 1)) == 45);
            					}
            					else {
HXLINE( 349)						_hx_tmp25 = false;
            					}
HXDLIN( 349)					if (_hx_tmp25) {
HXLINE( 349)						_hx_tmp24 = (str.cca((p + 2)) == 62);
            					}
            					else {
...
HXLINE( 353)						state = 1;
            				...
            				case (int)16: {
HXLINE( 356)					if ((c == 91)) {
HXLINE( 357)						nbrackets = (nbrackets + 1);
            					}
            					else {
HXLINE( 358)						if ((c == 93)) {
...
HXDLIN( 360)							if ((c == 62)) {
HXLINE( 360)								_hx_tmp26 = (nbrackets == 0);
            							}
            							else {
...
HXDLIN( 187)					if ((c == 93)) {
HXLINE( 187)						_hx_tmp28 = (str.cca((p + 1)) == 93);
            					}
            					else {
HXLINE( 187)						_hx_tmp28 = false;
            					}
HXDLIN( 187)					if (_hx_tmp28) {
HXLINE( 187)						_hx_tmp27 = (str.cca((p + 2)) == 62);
            					}
            					else {
...
HXDLIN( 400)								buf->charBuf->push(( (int)(c1) ));
            							}
            						}
            						else {
...
HXLINE( 404)										::Array< ::String > buf6 = buf->b;
HXDLIN( 404)										buf6->push(::Std_obj::string(x));
            									}
            								}
            							}
            							else {
HXLINE( 406)								::String x1 = ::haxe::xml::Parser_obj::escapes->get_string(s);
...
HXLINE( 406)									::Array< ::String > buf7 = buf->b;
HXDLIN( 406)									buf7->push(::Std_obj::string(x1));
            								}
            							}
            						}
HXLINE( 408)						start = (p + 1);
...
HXDLIN( 413)								buf->charBuf->push(38);
            							}
HXLINE( 414)							{
...
HXLINE( 414)									::Array< ::String > buf8 = buf->b;
HXDLIN( 414)									buf8->push(str.substr(start,len5));
            								}
            							}
HXLINE( 415)							p = (p - 1);
HXLINE( 416)							start = (p + 1);
...
HXLINE( 423)		if ((state == 1)) {
HXLINE( 425)			start = p;
HXLINE( 426)			state = 13;
            		}
HXLINE( 429)		if ((state == 13)) {
HXLINE( 431)			bool _hx_tmp37;
HXDLIN( 431)			if ((p == start)) {
HXLINE( 431)				_hx_tmp37 = (nsubs == 0);
            			}
            			else {
...
HXLINE( 438)			_hx_tmp39 = (state == 18);
            		}
            		else {
HXLINE( 438)			_hx_tmp39 = false;
            		}
HXDLIN( 438)		if (_hx_tmp39) {
HXLINE( 438)			_hx_tmp38 = (escapeNext == 13);
            		}
            		else {
...
HXDLIN( 439)				buf->charBuf->push(38);
            			}
HXLINE( 440)			{
...
{
{
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::haxe::ds::StringMap _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_3d0c265eae779593_104_boot)
...
HXLINE( 111)			return h;
            	...
            	HX_STACKFRAME(&_hx_pos_3d0c265eae779593_104_boot)
HXDLIN( 104)		escapes = ( ( ::haxe::ds::StringMap)( ::Dynamic(new _hx_Closure_0())()) );
            	}
}
