...
HX_DEFINE_STACK_FRAME(_hx_pos_85f85a296671a661_34_new,"haxe.iterators.MapKeyValueIterator","new",0x902a97fd,"haxe.iterators.MapKeyValueIterator.new","/home/hedgehog/Program/KodeStudio-Linux/resources/app/kodeExtensions/kha/Kha/Tools/haxe/std/haxe/iterators/MapKeyValueIterator.hx",34,0x4cf2e1f9)
HX_LOCAL_STACK_FRAME(_hx_pos_85f85a296671a661_43_hasNext,"haxe.iterators.MapKeyValueIterator","hasNext",0x6e75ff8a,"haxe.iterators.MapKeyValueIterator.hasNext","/home/hedgehog/Program/KodeStudio-Linux/resources/app/kodeExtensions/kha/Kha/Tools/haxe/std/haxe/iterators/MapKeyValueIterator.hx",43,0x4cf2e1f9)
HX_LOCAL_STACK_FRAME(_hx_pos_85f85a296671a661_49_next,"haxe.iterators.MapKeyValueIterator","next",0x951a66b6,"haxe.iterators.MapKeyValueIterator.next","/home/hedgehog/Program/KodeStudio-Linux/resources/app/kodeExtensions/kha/Kha/Tools/haxe/std/haxe/iterators/MapKeyValueIterator.hx",49,0x4cf2e1f9)
namespace haxe{
namespace iterators{

void MapKeyValueIterator_obj::__construct(::Dynamic map){
            	HX_STACKFRAME(&_hx_pos_85f85a296671a661_34_new)
HXLINE(  35)		this->map = map;
HXLINE(  36)		this->keys = ::haxe::IMap_obj::keys(map);
            	}
...
bool MapKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_85f85a296671a661_43_hasNext)
HXDLIN(  43)		return ( (bool)(this->keys->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(MapKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic MapKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_85f85a296671a661_49_next)
HXLINE(  50)		 ::Dynamic key = this->keys->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)();
