...
HXDLIN( 262)				{
HXLINE( 262)					 ::nape::geom::Vec2 o = localCOM;
HXDLIN( 262)					o->zpp_pool = null();
HXDLIN( 262)					if (hx::IsNotNull( ::zpp_nape::util::ZPP_PubPool_obj::nextVec2 )) {
HXLINE( 262)						::zpp_nape::util::ZPP_PubPool_obj::nextVec2->zpp_pool = o;
            					}
            					else {
HXLINE( 262)						::zpp_nape::util::ZPP_PubPool_obj::poolVec2 = o;
            					}
HXDLIN( 262)					::zpp_nape::util::ZPP_PubPool_obj::nextVec2 = o;
HXDLIN( 262)					o->zpp_disp = true;
            				}
HXDLIN( 262)				{
HXLINE( 262)					 ::zpp_nape::geom::ZPP_Vec2 o1 = inner;
HXDLIN( 262)					{
HXLINE( 262)						if (hx::IsNotNull( o1->outer )) {
HXLINE( 262)							o1->outer->zpp_inner = null();
HXDLIN( 262)							o1->outer = null();
            						}
HXDLIN( 262)						o1->_isimmutable = null();
HXDLIN( 262)						o1->_validate = null();
HXDLIN( 262)						o1->_invalidate = null();
            					}
HXDLIN( 262)					o1->next = ::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool;
HXDLIN( 262)					::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool = o1;
            				}
            			}
            		}
