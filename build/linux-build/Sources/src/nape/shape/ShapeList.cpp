...
HXLINE( 492)			 ::nape::shape::Shape retx = ret->outer;
...
HXLINE( 500)			 ::nape::shape::Shape retx1 = ret->outer;
...
HXLINE( 505)		 ::nape::shape::Shape retx2 = ret->outer;
...
HXLINE( 535)			 ::nape::shape::Shape retx = ret->outer;
...
HXLINE( 541)			 ::nape::shape::Shape retx1 = ret->outer;
...
HXLINE( 546)		 ::nape::shape::Shape retx2 = ret->outer;
...
HXLINE( 590)					 ::zpp_nape::shape::ZPP_Shape x = cx_ite->elt;
