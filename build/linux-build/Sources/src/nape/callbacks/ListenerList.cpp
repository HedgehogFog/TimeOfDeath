...
HXLINE( 492)			 ::nape::callbacks::Listener retx = ret->outer;
...
HXLINE( 500)			 ::nape::callbacks::Listener retx1 = ret->outer;
...
HXLINE( 505)		 ::nape::callbacks::Listener retx2 = ret->outer;
...
HXLINE( 535)			 ::nape::callbacks::Listener retx = ret->outer;
...
HXLINE( 541)			 ::nape::callbacks::Listener retx1 = ret->outer;
...
HXLINE( 546)		 ::nape::callbacks::Listener retx2 = ret->outer;
...
HXLINE( 590)					 ::zpp_nape::callbacks::ZPP_Listener x = cx_ite->elt;
