...
HXLINE( 492)			 ::nape::dynamics::InteractionGroup retx = ret->outer;
...
HXLINE( 500)			 ::nape::dynamics::InteractionGroup retx1 = ret->outer;
...
HXLINE( 505)		 ::nape::dynamics::InteractionGroup retx2 = ret->outer;
...
HXLINE( 535)			 ::nape::dynamics::InteractionGroup retx = ret->outer;
...
HXLINE( 541)			 ::nape::dynamics::InteractionGroup retx1 = ret->outer;
...
HXLINE( 546)		 ::nape::dynamics::InteractionGroup retx2 = ret->outer;
...
HXLINE( 590)					 ::zpp_nape::dynamics::ZPP_InteractionGroup x = cx_ite->elt;
