...
HXLINE( 492)			 ::nape::geom::ConvexResult retx = ret;
...
HXLINE( 500)			 ::nape::geom::ConvexResult retx1 = ret;
...
HXLINE( 505)		 ::nape::geom::ConvexResult retx2 = ret;
...
HXLINE( 535)			 ::nape::geom::ConvexResult retx = ret;
...
HXLINE( 541)			 ::nape::geom::ConvexResult retx1 = ret;
...
HXLINE( 546)		 ::nape::geom::ConvexResult retx2 = ret;
...
HXLINE( 590)					 ::nape::geom::ConvexResult x = cx_ite->elt;
HXLINE( 592)					if (hx::IsEq( x,obj )) {
HXLINE( 593)						ret = true;
