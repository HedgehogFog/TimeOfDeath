...
HXLINE( 492)			 ::nape::phys::Body retx = ret->outer;
...
HXLINE( 500)			 ::nape::phys::Body retx1 = ret->outer;
...
HXLINE( 505)		 ::nape::phys::Body retx2 = ret->outer;
...
HXLINE( 535)			 ::nape::phys::Body retx = ret->outer;
...
HXLINE( 541)			 ::nape::phys::Body retx1 = ret->outer;
...
HXLINE( 546)		 ::nape::phys::Body retx2 = ret->outer;
...
HXLINE( 590)					 ::zpp_nape::phys::ZPP_Body x = cx_ite->elt;
