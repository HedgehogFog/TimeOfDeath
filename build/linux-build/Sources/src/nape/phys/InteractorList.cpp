...
HXLINE( 492)			 ::nape::phys::Interactor retx = ret->outer_i;
...
HXLINE( 500)			 ::nape::phys::Interactor retx1 = ret->outer_i;
...
HXLINE( 505)		 ::nape::phys::Interactor retx2 = ret->outer_i;
...
HXLINE( 535)			 ::nape::phys::Interactor retx = ret->outer_i;
...
HXLINE( 541)			 ::nape::phys::Interactor retx1 = ret->outer_i;
...
HXLINE( 546)		 ::nape::phys::Interactor retx2 = ret->outer_i;
...
HXLINE( 590)					 ::zpp_nape::phys::ZPP_Interactor x = cx_ite->elt;
HXLINE( 592)					if (hx::IsEq( x,obj->zpp_inner_i )) {
HXLINE( 593)						ret = true;
