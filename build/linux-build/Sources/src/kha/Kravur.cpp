...
HXDLIN( 167)				int _g11 = baked->length;
...
HXLINE( 188)			int ascent = ::Math_obj::round((( (Float)(metrics->ascent) ) * scale));
HXLINE( 189)			int descent = ::Math_obj::round((( (Float)(metrics->descent) ) * scale));
HXLINE( 190)			int lineGap = ::Math_obj::round((( (Float)(metrics->lineGap) ) * scale));
...
HXDLIN( 200)		return this->_get(fontSize)->getHeight();
            	}
...
HXDLIN( 204)		return this->_get(fontSize)->stringWidth(str);
            	}
...
HXDLIN( 208)		return this->_get(fontSize)->charactersWidth(characters,start,length);
            	}
...
HXDLIN( 212)		return this->_get(fontSize)->getBaselinePosition();
            	}
