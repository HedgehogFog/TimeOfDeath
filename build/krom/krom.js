...
Project.prototype = {
	update: function() {
		scene_managment_SceneManager.instance.update();
	}
	,render: function(framebuffer) {
		var g2 = framebuffer.get_g2();
		scene_managment_SceneManager.instance.draw(g2);
	}
	,__class__: Project
};
...
Xml.__name__ = true;
var entity_element_IEntity = $hxClasses["entity.element.IEntity"] = function() { };
entity_element_IEntity.__name__ = true;
entity_element_IEntity.prototype = {
	name: null
	,active: null
	,visible: null
	,alive: null
	...
	,kill: null
	,revive: null
	,__class__: entity_element_IEntity
};
var entity_element_Entity = $hxClasses["entity.element.Entity"] = function() {
	this.alive = true;
	this.visible = true;
	this.active = true;
	this.name = "Entity";
};
entity_element_Entity.__name__ = true;
entity_element_Entity.__interfaces__ = [entity_element_IEntity];
entity_element_Entity.prototype = {
	name: null
	,active: null
	,visible: null
	,alive: null
	...
	,__class__: entity_element_Entity
};
var entity_element_user_Player = $hxClasses["entity.element.user.Player"] = function(x,y) {
	entity_element_Entity.call(this);
	this.x = x;
	this.y = y;
	kha_input_Keyboard.get().notify($bind(this,this.downListener),$bind(this,this.upListener),null);
};
entity_element_user_Player.__name__ = true;
entity_element_user_Player.__super__ = entity_element_Entity;
entity_element_user_Player.prototype = $extend(entity_element_Entity.prototype,{
	x: null
	,y: null
	,update: function(dt) {
	}
	,draw: function(gr) {
		gr.drawRect(this.x,this.y,this.x + 50,this.y + 50,10);
	}
	...
	,__class__: entity_element_user_Player
});
var entity_group_TypedGroup = $hxClasses["entity.group.TypedGroup"] = function(groupName) {
	this.alive = true;
	this.visible = true;
	this.active = true;
	this.name = "Group";
...
entity_group_TypedGroup.__name__ = true;
entity_group_TypedGroup.__interfaces__ = [entity_element_IEntity];
entity_group_TypedGroup.prototype = {
	name: null
	,active: null
	,visible: null
	,alive: null
	,members: null
	,add: function(entity1) {
		if(entity1 == null) {
			haxe_Log.trace("Add obj not be null",{ fileName : "entity/group/Group.hx", lineNumber : 29, className : "entity.group.TypedGroup", methodName : "add"});
			return;
		}
		if(this.members.indexOf(entity1) >= 0) {
			haxe_Log.trace("Object exist yje",{ fileName : "entity/group/Group.hx", lineNumber : 34, className : "entity.group.TypedGroup", methodName : "add"});
			return;
		}
		var index = this.getFirstNull();
		if(index != -1) {
			this.members[index] = entity1;
			return;
		}
		this.members.push(entity1);
	}
	,remove: function(entity1,splice) {
		if(splice == null) {
			splice = false;
		}
		...
		var index = this.members.indexOf(entity1);
		if(index < 0) {
			return;
		}
		if(splice) {
	...
	,draw: function(gr) {
		...
		while(_g < _g1.length) {
			var entity1 = _g1[_g];
			++_g;
			if(entity1 != null && entity1.visible) {
				entity1.draw(gr);
			}
		}
	}
	,update: function(dt) {
		...
		while(_g < _g1.length) {
			var entity1 = _g1[_g];
			++_g;
			if(entity1 != null && entity1.active) {
				entity1.update(dt);
			}
		}
	}
	...
	,__class__: entity_group_TypedGroup
};
...
var kha__$Assets_BlobList = $hxClasses["kha._Assets.BlobList"] = function() {
	this.names = ["l0_xml"];
	this.l0_xmlDescription = { name : "l0_xml", files : ["l0.xml"], type : "blob"};
	this.l0_xmlName = "l0_xml";
	this.l0_xml = null;
};
...
kha__$Assets_BlobList.prototype = {
	...
	,l0_xml: null
	,l0_xmlName: null
	,l0_xmlDescription: null
	,l0_xmlLoad: function(done,failure) {
		var tmp;
		if(failure != null) {
			tmp = failure;
		} else {
			var f = haxe_Log.trace;
			var infos = { fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 138, className : "kha._Assets.BlobList", methodName : "l0_xmlLoad"};
			tmp = function(v) {
				f(v,infos);
			};
		}
		kha_Assets.loadBlob("l0_xml",function(blob) {
			done();
		},tmp,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 138, className : "kha._Assets.BlobList", methodName : "l0_xmlLoad"});
	}
	,l0_xmlUnload: function() {
		this.l0_xml.unload();
		this.l0_xml = null;
	}
	,names: null
...
var kha__$Assets_FontList = $hxClasses["kha._Assets.FontList"] = function() {
	this.names = ["OpenSans"];
	this.OpenSansDescription = { name : "OpenSans", files : ["OpenSans.ttf"], type : "font"};
	this.OpenSansName = "OpenSans";
	this.OpenSans = null;
};
...
kha__$Assets_FontList.prototype = {
	...
	,OpenSans: null
	,OpenSansName: null
	,OpenSansDescription: null
	,OpenSansLoad: function(done,failure) {
		var tmp;
		if(failure != null) {
			tmp = failure;
		} else {
			var f = haxe_Log.trace;
			var infos = { fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 142, className : "kha._Assets.FontList", methodName : "OpenSansLoad"};
			tmp = function(v) {
				f(v,infos);
			};
		}
		kha_Assets.loadFont("OpenSans",function(font) {
			done();
		},tmp,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 142, className : "kha._Assets.FontList", methodName : "OpenSansLoad"});
	}
	,OpenSansUnload: function() {
		this.OpenSans.unload();
		this.OpenSans = null;
	}
	,names: null
...
var scene_Scene = $hxClasses["scene.Scene"] = function() { };
scene_Scene.__name__ = true;
...
var scene_impl_GameScene = $hxClasses["scene.impl.GameScene"] = function() {
	this.loadTime = 2.0;
	this.playerGroup = new entity_group_TypedGroup();
	this.playerGroup.add(new entity_element_user_Player(250,250));
	this.playerGroup.add(new entity_element_user_Player(10,10));
	this.currentStage = new world_Stage("l0.xml");
};
scene_impl_GameScene.__name__ = true;
scene_impl_GameScene.__interfaces__ = [scene_Scene];
scene_impl_GameScene.prototype = {
	currentStage: null
	,playerGroup: null
	,draw: function(gr) {
		gr.begin(true,-16777216);
		this.playerGroup.draw(gr);
		gr.set_font(kha_Assets.fonts.OpenSans);
		gr.set_fontSize(24);
	...
	,__class__: scene_impl_GameScene
};
var scene_impl_PreloaderScene = $hxClasses["scene.impl.PreloaderScene"] = function() {
	this.loadTime = 2.0;
};
scene_impl_PreloaderScene.__name__ = true;
scene_impl_PreloaderScene.__interfaces__ = [scene_Scene];
scene_impl_PreloaderScene.prototype = {
	draw: function(gr) {
		gr.begin(true,-16777216);
		gr.set_font(kha_Assets.fonts.OpenSans);
		gr.set_fontSize(24);
	...
	,update: function(dt) {
		if(this.loadTime > 0) {
			...
			scene_managment_SceneManager.instance.setScene(new scene_impl_GameScene());
		}
	}
	,destroy: function() {
	}
	,__class__: scene_impl_PreloaderScene
};
var util_Timer = $hxClasses["util.Timer"] = function() {
};
util_Timer.__name__ = true;
util_Timer.prototype = {
	delta: null
	,current: null
	,update: function() {
	...
	,__class__: util_Timer
};
var scene_managment_SceneManager = $hxClasses["scene.managment.SceneManager"] = function() {
	this.currentScene = new scene_impl_PreloaderScene();
	this.timer = new util_Timer();
};
scene_managment_SceneManager.__name__ = true;
scene_managment_SceneManager.prototype = {
	timer: null
	,currentScene: null
	,draw: function(gr) {
		this.currentScene.draw(gr);
	}
	,update: function() {
		this.timer.update();
		this.currentScene.update(this.timer.delta);
	}
	,setScene: function(scene1) {
		this.currentScene.destroy();
		this.currentScene = scene1;
	}
	,__class__: scene_managment_SceneManager
};
var world_Stage = $hxClasses["world.Stage"] = function(file) {
	if(file != null) {
		this.setStage(file);
	}
};
world_Stage.__name__ = true;
world_Stage.prototype = {
	values: null
	,objects: null
	,xml: null
	,fastXml: null
	,setStage: function(file) {
		this.values = new haxe_ds_StringMap();
		this.objects = new haxe_ds_StringMap();
		var data;
		kha_Assets.loadBlob(file,function(done) {
			data = done.toString();
			return data;
		},function(fail) {
			haxe_Log.trace(fail,{ fileName : "world/Stage.hx", lineNumber : 27, className : "world.Stage", methodName : "setStage"});
			return;
		},{ fileName : "world/Stage.hx", lineNumber : 27, className : "world.Stage", methodName : "setStage"});
		haxe_Log.trace(data,{ fileName : "world/Stage.hx", lineNumber : 28, className : "world.Stage", methodName : "setStage"});
	}
	,__class__: world_Stage
};
...
kha_Shaders.painter_colored_fragData0 = "s260:";
kha_Shaders.painter_colored_vertData0 = "s463:";
kha_Shaders.painter_image_fragData0 = "s502:";
kha_Shaders.painter_image_vertData0 = "s547:";
kha_Shaders.painter_text_fragData0 = "s398:";
kha_Shaders.painter_text_vertData0 = "s568:";
kha_Shaders.painter_video_fragData0 = "s502:";
kha_Shaders.painter_video_vertData0 = "s547:";
...
scene_managment_SceneManager.instance = new scene_managment_SceneManager();
Main.main();
