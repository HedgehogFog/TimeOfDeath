...
var entity_element_IEntity = function() { };
$hxClasses["entity.element.IEntity"] = entity_element_IEntity;
entity_element_IEntity.__name__ = "entity.element.IEntity";
...
var entity_element_Entity = function() {
	this.alive = true;
	this.visible = true;
	this.active = true;
	this.name = "Entity";
};
$hxClasses["entity.element.Entity"] = entity_element_Entity;
entity_element_Entity.__name__ = "entity.element.Entity";
...
var entity_element_user_Player = function(x,y) {
	entity_element_Entity.call(this);
	this.x = x;
	this.y = y;
	kha_input_Keyboard.get().notify($bind(this,this.downListener),$bind(this,this.upListener),null);
};
$hxClasses["entity.element.user.Player"] = entity_element_user_Player;
entity_element_user_Player.__name__ = "entity.element.user.Player";
...
var entity_group_TypedGroup = function(groupName) {
	this.alive = true;
	this.visible = true;
	this.active = true;
	this.name = "Group";
...
$hxClasses["entity.group.TypedGroup"] = entity_group_TypedGroup;
entity_group_TypedGroup.__name__ = "entity.group.TypedGroup";
...
var scene_impl_GameScene = function() {
	this.loadTime = 2.0;
	...
	this.currentStage = new world_Stage("l0_xml");
};
$hxClasses["scene.impl.GameScene"] = scene_impl_GameScene;
scene_impl_GameScene.__name__ = "scene.impl.GameScene";
...
var scene_impl_PreloaderScene = function() {
	this.loadTime = 2.0;
};
$hxClasses["scene.impl.PreloaderScene"] = scene_impl_PreloaderScene;
scene_impl_PreloaderScene.__name__ = "scene.impl.PreloaderScene";
...
var util_Timer = function() {
};
$hxClasses["util.Timer"] = util_Timer;
util_Timer.__name__ = "util.Timer";
...
var scene_managment_SceneManager = function() {
	this.currentScene = new scene_impl_PreloaderScene();
	this.timer = new util_Timer();
};
$hxClasses["scene.managment.SceneManager"] = scene_managment_SceneManager;
scene_managment_SceneManager.__name__ = "scene.managment.SceneManager";
...
var world_Stage = function(file) {
	if(file != null) {
		this.setStage(file);
	}
};
$hxClasses["world.Stage"] = world_Stage;
world_Stage.__name__ = "world.Stage";
world_Stage.prototype = {
	...
	,setStage: function(file) {
		...
		kha_Assets.loadBlob(file,$bind(this,this.loadSucc),function(fail) {
			haxe_Log.trace(fail,{ fileName : "world/Stage.hx", lineNumber : 33, className : "world.Stage", methodName : "setStage"});
			return;
		},{ fileName : "world/Stage.hx", lineNumber : 33, className : "world.Stage", methodName : "setStage"});
	}
	,loadSucc: function(blob) {
		var data = blob.toString();
		this.xml = haxe_xml_Parser.parse(data);
		var x = this.xml.firstElement();
		if(x.nodeType != Xml.Document && x.nodeType != Xml.Element) {
			throw new js__$Boot_HaxeError("Invalid nodeType " + x.nodeType);
		}
		var this1 = x;
		this.fastXml = this1;
		if(haxe_xml__$Access_HasAttribAccess_$Impl_$.resolve(this.fastXml,"width")) {
			this.width = Std.parseInt(haxe_xml__$Access_AttribAccess_$Impl_$.resolve(this.fastXml,"width"));
		}
		if(haxe_xml__$Access_HasAttribAccess_$Impl_$.resolve(this.fastXml,"height")) {
			this.height = Std.parseInt(haxe_xml__$Access_AttribAccess_$Impl_$.resolve(this.fastXml,"height"));
		}
		if(haxe_xml__$Access_HasAttribAccess_$Impl_$.resolve(this.fastXml,"name")) {
			this.name = haxe_xml__$Access_AttribAccess_$Impl_$.resolve(this.fastXml,"name");
		}
		if(haxe_xml__$Access_HasAttribAccess_$Impl_$.resolve(this.fastXml,"desc")) {
			this.desc = haxe_xml__$Access_AttribAccess_$Impl_$.resolve(this.fastXml,"desc");
		}
		if(haxe_xml__$Access_HasAttribAccess_$Impl_$.resolve(this.fastXml,"version")) {
			this.version = haxe_xml__$Access_AttribAccess_$Impl_$.resolve(this.fastXml,"version");
		}
		if(haxe_xml__$Access_HasAttribAccess_$Impl_$.resolve(this.fastXml,"bgColor")) {
			var tmp = haxe_xml__$Access_AttribAccess_$Impl_$.resolve(this.fastXml,"bgColor");
			scene_managment_SceneManager.instance.currentScene.bgColor = kha__$Color_Color_$Impl_$.fromString(tmp);
		}
	}
